...
1*m);return k}function W(k,m){var w=!1;0>k&&(w=!0,k*=-1);k=""+k;for(m=m?m:1;k.length<m;)k="0"+k;return w?"-"+k:k}function Ea(k){if(!k)return k;k=k.replace(/^\s\s*/,"");for(var m=/\s/,w=k.length;m.test(k.charAt(--w)););return k.slice(0,w+1)}function Aa(k){k.roundRect=function(k,w,s,u,oa,D,y,E){y&&(this.fillStyle=y);E&&(this.strokeStyle=E);"undefined"===typeof oa&&(oa=5);this.lineWidth=D;this.beginPath();this.moveTo(k+oa,w);this.lineTo(k+s-oa,w);this.quadraticCurveTo(k+s,w,k+s,w+oa);this.lineTo(k+s,
w+u-oa);this.quadraticCurveTo(k+s,w+u,k+s-oa,w+u);this.lineTo(k+oa,w+u);this.quadraticCurveTo(k,w+u,k,w+u-oa);this.lineTo(k,w+oa);this.quadraticCurveTo(k,w,k+oa,w);this.closePath();y&&this.fill();E&&0<D&&this.stroke()}}function Pa(k,m){return k-m}function R(k){var m=((k&16711680)>>16).toString(16),w=((k&65280)>>8).toString(16);k=((k&255)>>0).toString(16);m=2>m.length?"0"+m:m;w=2>w.length?"0"+w:w;k=2>k.length?"0"+k:k;return"#"+m+w+k}function cb(k,m){var w=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=w);s<w;s++)if(s in this&&this[s]===k)return s;return-1}function s(k){return null===k||"undefined"===typeof k}function Ba(k){k.indexOf||(k.indexOf=cb);return k}function db(k){if(Fa.fSDec)k[fa("`eeDwdouMhrudods")](fa("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){Fa._fTWm&&Fa._fTWm(k)})}function Wa(k,m,w){w=w||"normal";var s=k+"_"+m+"_"+w,u=Xa[s];if(isNaN(u)){try{k="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
...
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[k||"solid"])for(var s=0;s<w.length;s++)w[s]*=m;else w=[];return w}function K(k,m,w,s,u){s=s||[];u=u||!1;s.push([k,m,w,u]);return k.addEventListener?(k.addEventListener(m,w,u),w):k.attachEvent?(s=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};w.call(k,m)},k.attachEvent("on"+m,s),s):!1}function eb(k){if(k._menuButton)k.exportEnabled?
Ka(k._menuButton):sa(k._menuButton);else if(k.exportEnabled&&u){var m=!1;k._menuButton=document.createElement("button");ta(k,k._menuButton,"menu");k._toolBar.appendChild(k._menuButton);K(k._menuButton,"touchstart",function(k){m=!0},k.allDOMEventHandlers);K(k._menuButton,"click",function(){"none"!==k._dropdownMenu.style.display||k._dropDownCloseTime&&500>=(new Date).getTime()-k._dropDownCloseTime.getTime()||(k._dropdownMenu.style.display="block",k._menuButton.blur(),k._dropdownMenu.focus())},k.allDOMEventHandlers,
!0);K(k._menuButton,"mouseover",function(){m||(na(k,k._menuButton,{backgroundColor:k.toolbar.backgroundColorOnHover,color:k.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&na(k,k._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},k.allDOMEventHandlers,!0);K(k._menuButton,"mouseout",function(){m||(na(k,k._menuButton,{backgroundColor:k.toolbar.backgroundColor,color:k.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&na(k,k._menuButton.childNodes[0],
{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},k.allDOMEventHandlers,!0)}if(!k._dropdownMenu&&k.exportEnabled&&u){m=!1;k._dropdownMenu=document.createElement("div");k._dropdownMenu.setAttribute("tabindex",-1);var w=-1!==k.theme.indexOf("dark")?"black":"#888888";k._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
k.toolbar.backgroundColor+";box-shadow: 2px 2px 10px "+w;k._dropdownMenu.style.display="none";k._toolBar.appendChild(k._dropdownMenu);K(k._dropdownMenu,"blur",function(){sa(k._dropdownMenu);k._dropDownCloseTime=new Date},k.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=k._cultureInfo.printText;w.style.backgroundColor=k.toolbar.backgroundColor;w.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(w);K(w,"touchstart",function(k){m=
!0},k.allDOMEventHandlers);K(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);K(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0);K(w,"click",function(){k.print();sa(k._dropdownMenu)},k.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=
k._cultureInfo.saveJPGText;w.style.backgroundColor=k.toolbar.backgroundColor;w.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(w);K(w,"touchstart",function(k){m=!0},k.allDOMEventHandlers);K(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);K(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,
!0);K(w,"click",function(){k.exportChart({format:"jpeg",fileName:k.exportFileName});sa(k._dropdownMenu)},k.allDOMEventHandlers,!0);w=document.createElement("div");w.style.cssText="padding: 12px 8px 12px 8px";w.innerHTML=k._cultureInfo.savePNGText;w.style.backgroundColor=k.toolbar.backgroundColor;w.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(w);K(w,"touchstart",function(k){m=!0},k.allDOMEventHandlers);K(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,
this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);K(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0);K(w,"click",function(){k.exportChart({format:"png",fileName:k.exportFileName});sa(k._dropdownMenu)},k.allDOMEventHandlers,!0)}}function Ya(k,m,w){k*=X;m*=X;k=w.getImageData(k,m,2,2).data;m=!0;for(w=0;4>w;w++)if(k[w]!==k[w+4]|k[w]!==k[w+8]|k[w]!==k[w+12]){m=!1;break}return m?k[0]<<
16|k[1]<<8|k[2]:0}function ga(k,m,w){return k in m?m[k]:w[k]}function La(k,m,w){if(u&&Za){var s=k.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;X=Qa/Ma;k.width=m*X;k.height=w*X;Qa!==Ma&&(k.style.width=m+"px",k.style.height=w+"px",s.scale(X,X))}else k.width=m,k.height=w}function fb(k){if(!gb){var m=!1,w=!1;"undefined"===typeof va.Chart.creditHref?(k.creditHref=fa("iuuqr;..b`ow`rkr/bnl."),
...
var w=document.createElement("canvas");w.setAttribute("class","canvasjs-chart-canvas");La(w,k,m);u||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(w);return w}function na(k,m,w){for(var s in w)m.style[s]=w[s]}function ta(k,m,w){m.getAttribute("state")||(m.style.backgroundColor=k.toolbar.backgroundColor,m.style.color=k.toolbar.fontColor,m.style.border="none",na(k,m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
...
typeof u&&(u=0);this._padding=u;this._x1=k;this._y1=m;this._x2=w;this._y2=s;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ha(k,m){ha.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=k;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Sa(k,m){Sa.base.constructor.call(this,"Toolbar","toolbar",m,null,k);this.chart=k;this.canvas=k.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function wa(k,m){wa.base.constructor.call(this,
...
[]}function Ia(k){var m;k&&Ja[k]&&(m=Ja[k]);Ia.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ga=!1,Fa={},u=!!document.createElement("canvas").getContext,va={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
snapToDataPoint:!1,color:"grey",opacity:null,thickness:2,lineDashType:"solid",label:"",labelWrap:!0,labelMaxWidth:null,labelBackgroundColor:u?"grey":null,labelBorderColor:u?"grey":null,labelBorderThickness:0,labelCornerRadius:0,labelFontFamily:u?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":"calibri",labelFontSize:12,labelFontColor:"#fff",labelFontWeight:"normal",labelFontStyle:"normal",labelFormatter:null,valueFormatString:null,updated:null,hidden:null,publicProperties:{options:"readWrite",
...
panText:"Pan",resetText:"Reset",menuText:"More Options",saveJPGText:"Save as JPEG",savePNGText:"Save as PNG",printText:"Print",days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),shortDays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),months:"January February March April May June July August September October November December".split(" "),shortMonths:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}},Ja={en:{}},y=u?"Trebuchet MS, Helvetica, sans-serif":"Arial",Da=u?"Impact, Charcoal, sans-serif":
"Arial",xa={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},L,aa,Q,da,ca;aa="#333333";Q="#000000";L="#666666";ca=da="#000000";var ba=20,E=14,Ua={colorSet:"colorSet1",
backgroundColor:"#FFFFFF",title:{fontFamily:Da,fontSize:32,fontColor:aa,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Da,fontSize:E,fontColor:aa,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:E,indexLabelFontColor:aa,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:aa,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",
lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:0,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,
titleFontSize:ba,titleFontColor:aa,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:0,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,
thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:aa,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:1,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,
color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:aa,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,
gridThickness:1,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],legend:{fontFamily:y,fontSize:14,fontColor:aa,fontWeight:"bold",
verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1}};Q=aa="#F5F5F5";L="#FFFFFF";da="#40BAF1";ca="#F5F5F5";var ba=20,E=14,$a={colorSet:"colorSet2",title:{fontFamily:y,fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:E,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:E,indexLabelFontColor:"#666666",
...
labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,
gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:"#666666",
titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",
thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",
labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],legend:{fontFamily:y,fontSize:14,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,
borderThickness:1}};Q=aa="#F5F5F5";L="#FFFFFF";da="#40BAF1";ca="#F5F5F5";ba=20;E=14;Da={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Da,fontSize:32,fontColor:aa,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Da,fontSize:E,fontColor:aa,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{backgroundColor:"#666666",backgroundColorOnHover:"#FF7372",borderColor:"#FF7372",borderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,
indexLabelFontSize:E,indexLabelFontColor:Q,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:0,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:0,gridColor:L,stripLines:[{labelFontFamily:y,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,
labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:1,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:1,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:aa,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:Q,backgroundColor:"rgba(0, 0, 0, .7)"}};L="#FFFFFF";Q=aa="#FAFAFA";da="#40BAF1";ca="#F5F5F5";
var ba=20,E=14,ab={light1:Ua,light2:$a,dark1:Da,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:y,fontSize:32,fontColor:aa,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:E,fontColor:aa,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{backgroundColor:"#666666",backgroundColorOnHover:"#FF7372",borderColor:"#FF7372",borderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,indexLabelFontSize:E,
indexLabelFontColor:Q,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:0,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:1,lineColor:L,tickThickness:1,tickColor:L,gridThickness:0,gridColor:L,stripLines:[{labelFontFamily:y,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,
labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:0,lineColor:L,tickThickness:1,tickColor:L,gridThickness:1,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:y,titleFontSize:ba,titleFontColor:Q,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:E,labelFontColor:Q,labelFontWeight:"normal",lineThickness:0,lineColor:L,tickThickness:1,tickColor:L,gridThickness:1,gridColor:L,stripLines:[{labelFontFamily:y,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:E,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:ca,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:aa,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:Q,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Ua,theme2:$a,theme3:Ua},U={numberDuration:1,
yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")},Xa={},pa=null,ib=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},jb=function(k,m,w){m=Math.min(this.width,this.height);return Math.max("theme4"===
this.theme?0:300<=m?12:11,Math.round(m*(k/400)))},ya=function(){var k=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),w="Sun Mon Tue Wed Thu Fri Sat".split(" "),s="January February March April May June July August September October November December".split(" "),u="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),y=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
D=/[^-+\dA-Z]/g;return function(E,N,O){var L=O?O.days:m,R=O?O.months:s,K=O?O.shortDays:w,U=O?O.shortMonths:u;O="";var H=!1;E=E&&E.getTime?E:E?new Date(E):new Date;if(isNaN(E))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),H=!0);O=H?"getUTC":"get";var Q=E[O+"Date"](),J=E[O+"Day"](),V=E[O+"Month"](),a=E[O+"FullYear"](),d=E[O+"Hours"](),c=E[O+"Minutes"](),b=E[O+"Seconds"](),e=E[O+"Milliseconds"](),f=H?0:E.getTimezoneOffset();return O=N.replace(k,function(p){switch(p){case "D":return Q;
case "DD":return W(Q,2);case "DDD":return K[J];case "DDDD":return L[J];case "M":return V+1;case "MM":return W(V+1,2);case "MMM":return U[V];case "MMMM":return R[V];case "Y":return parseInt(String(a).slice(-2));case "YY":return W(String(a).slice(-2),2);case "YYY":return W(String(a).slice(-3),3);case "YYYY":return W(a,4);case "h":return d%12||12;case "hh":return W(d%12||12,2);case "H":return d;case "HH":return W(d,2);case "m":return c;case "mm":return W(c,2);case "s":return b;case "ss":return W(b,2);
case "f":return String(e).slice(0,1);case "ff":return W(String(e).slice(0,2),2);case "fff":return W(String(e).slice(0,3),3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return H?"UTC":(String(E).match(y)||[""]).pop().replace(D,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2)+W(Math.abs(f)%
60,2);default:return p.slice(1,p.length-1)}})}}(),Y=function(k,m,w){if(null===k)return"";if(!isFinite(k))return k;k=Number(k);var s=0>k?!0:!1;s&&(k*=-1);var u=w?w.decimalSeparator:".",y=w?w.digitGroupSeparator:",",D="";m=String(m);var D=1,E=w="",N=-1,O=[],L=[],R=0,K=0,U=0,H=!1,Q=0,E=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var J=0;E&&J<E.length;J++)if(m=E[J],"."===m&&0>N)N=J;else{if("%"===m)D*=100;else if("\u2030"===m){D*=1E3;continue}else if(","===m[0]&&"."===m[m.length-
1]){D/=Math.pow(1E3,m.length-1);N=J+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(H=!0);0>N?(O.push(m),"#"===m||"0"===m?R++:","===m&&U++):(L.push(m),"#"!==m&&"0"!==m||K++)}H&&(m=Math.floor(k),E=-Math.floor(Math.log(k)/Math.LN10+1),Q=0===k?0:0===m?-(R+E):String(m).length-R,D/=Math.pow(10,Q));0>N&&(N=J);D=(k*D).toFixed(K);m=D.split(".");D=(m[0]+"").split("");k=(m[1]+"").split("");D&&"0"===D[0]&&D.shift();for(H=E=J=K=N=0;0<O.length;)if(m=O.pop(),"#"===m||"0"===m)if(N++,N===R){var V=
D,D=[];if("0"===m)for(m=R-K-(V?V.length:0);0<m;)V.unshift("0"),m--;for(;0<V.length;)w=V.pop()+w,H++,0===H%E&&(J===U&&0<V.length)&&(w=y+w)}else 0<D.length?(w=D.pop()+w,K++,H++):"0"===m&&(w="0"+w,K++,H++),0===H%E&&(J===U&&0<D.length)&&(w=y+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(J++,E=H,H=0,0<D.length&&(w=y+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>Q?m.replace("+","").replace("-",
""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return W(Q,a.length)}));y="";for(O=!1;0<L.length;)m=L.shift(),"#"===m||"0"===m?0<k.length&&0!==Number(k.join(""))?(y+=k.shift(),O=!0):"0"===m&&(y+="0",O=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>Q?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return W(Q,a.length)}));
w+=(O?u:"")+y;return s?"-"+w:w},Na=function(k){var m=0,w=0;k=k||window.event;k.offsetX||0===k.offsetX?(m=k.offsetX,w=k.offsetY):k.layerX||0==k.layerX?(m=k.layerX,w=k.layerY):(m=k.pageX-k.target.offsetLeft,w=k.pageY-k.target.offsetTop);return{x:m,y:w}},Za=!0,Qa=window.devicePixelRatio||1,Ma=1,X=Za?Qa/Ma:1,Z=function(k,m,w,s,u,y,D,E,N,O,R,L,K){"undefined"===typeof K&&(K=1);D=D||0;E=E||"black";var H=15<s-m&&15<u-w?8:0.35*Math.min(s-m,u-w);k.beginPath();k.moveTo(m,w);k.save();k.fillStyle=y;k.globalAlpha=
K;k.fillRect(m,w,s-m,u-w);k.globalAlpha=1;0<D&&(K=0===D%2?0:0.5,k.beginPath(),k.lineWidth=D,k.strokeStyle=E,k.moveTo(m,w),k.rect(m-K,w-K,s-m+2*K,u-w+2*K),k.stroke());k.restore();!0===N&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+H,w+H),k.lineTo(s-H,w+H),k.lineTo(s,w),k.closePath(),D=k.createLinearGradient((s+m)/2,w+H,(s+m)/2,w),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=D,k.fill(),k.restore());!0===O&&(k.save(),k.beginPath(),k.moveTo(m,u),k.lineTo(m+H,u-H),k.lineTo(s-
H,u-H),k.lineTo(s,u),k.closePath(),D=k.createLinearGradient((s+m)/2,u-H,(s+m)/2,u),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=D,k.fill(),k.restore());!0===R&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+H,w+H),k.lineTo(m+H,u-H),k.lineTo(m,u),k.closePath(),D=k.createLinearGradient(m+H,(u+w)/2,m,(u+w)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,k.fill(),k.restore());!0===L&&(k.save(),k.beginPath(),k.moveTo(s,w),k.lineTo(s-H,
w+H),k.lineTo(s-H,u-H),k.lineTo(s,u),D=k.createLinearGradient(s-H,(u+w)/2,s,(u+w)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,k.fill(),k.closePath(),k.restore())},fa=function(k){for(var m="",s=0;s<k.length;s++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(s));return m},gb=window&&(window[fa("mnb`uhno")]&&window[fa("mnb`uhno")].href&&window[fa("mnb`uhno")].href.indexOf&&
(-1!==window[fa("mnb`uhno")].href.indexOf(fa("b`ow`rkr/bnl"))||-1!==window[fa("mnb`uhno")].href.indexOf(fa("gdonqhy/bnl"))||-1!==window[fa("mnb`uhno")].href.indexOf(fa("gheemd"))))&&-1===window[fa("mnb`uhno")].href.indexOf(fa("gheemd")),hb={reset:{image:"data:image/png;base64,"},
...
m=s):m=void 0,k[m]=this.options};H.prototype.remove=function(k){k="undefined"===typeof k?!0:k;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ba(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];k&&(this.stockChart||this.chart||this).render()};H.prototype.updateOption=function(k){!va[this._defaultsKey]&&(Ga&&window.console)&&console.log("defaults not set");var m=va[this._defaultsKey],u={},y=this[k],E=this._themeOptionsKey,
H=this._index;this.theme&&s(this.parent)&&s(E)&&s(H)?u=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[E])&&(null===H?u=this.parent.themeOptions[E]:0<this.parent.themeOptions[E].length&&(u=Math.min(this.parent.themeOptions[E].length-1,H),u=this.parent.themeOptions[E][u]));this.themeOptions=u;k in m&&(y=k in this.options?this.options[k]:u&&k in u?u[k]:m[k]);if(y===this[k])return!1;this[k]=
...
this._wrappedText.lines[s],"right"===this.horizontalAlign?u=this.width-E.width-this.rightPadding:"left"===this.horizontalAlign?u=this.leftPadding:"center"===this.horizontalAlign&&(u=(this.width-(this.leftPadding+this.rightPadding))/2-E.width/2+this.leftPadding),this.ctx.fillText(E.text,u,y),y+=E.height;this.ctx.font=m;k&&this.ctx.restore()}};ha.prototype.setText=function(k){this.text=k;this._isDirty=!0;this._wrappedText=null};ha.prototype.measureText=function(){this._lineHeight=Wa(this.fontFamily,
this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ha.prototype._getLineWithWidth=function(k,m,s){k=String(k);if(!k)return{text:"",width:0};var u=s=0,y=k.length-1,E=Infinity;for(this.ctx.font=this._getFontString();u<=y;){var E=Math.floor((u+y)/2),D=k.substr(0,E+1);s=this.ctx.measureText(D).width;if(s<m)u=E+1;else if(s>m)y=E-1;else break}s>m&&1<D.length&&(D=
D.substr(0,D.length-1),s=this.ctx.measureText(D).width);m=!0;if(D.length===k.length||" "===k[D.length])m=!1;m&&(k=D.split(" "),1<k.length&&k.pop(),D=k.join(" "),s=this.ctx.measureText(D).width);return{text:D,width:s}};ha.prototype._wrapText=function(){var k=new String(Ea(String(this.text))),m=[],s=this.ctx.font,u=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=u=0;else for(;0<k.length;){var E=this.maxHeight-(this.topPadding+this.bottomPadding),D=this._getLineWithWidth(k,this.maxWidth-
(this.leftPadding+this.rightPadding),!1);D.height=this._lineHeight;m.push(D);var H=y,y=Math.max(y,D.width),u=u+D.height,k=Ea(k.slice(D.text.length,k.length));E&&u>E&&(D=m.pop(),u-=D.height,y=H)}this._wrappedText={lines:m,width:y,height:u};this.width=y+(this.leftPadding+this.rightPadding);this.height=u+(this.topPadding+this.bottomPadding);this.ctx.font=s};ha.prototype._getFontString=function(){var k;k=""+(this.fontStyle?this.fontStyle+" ":"");k+=this.fontWeight?this.fontWeight+" ":"";k+=this.fontSize?
this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!u&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return k+=m};ma(Sa,H);ma(wa,H);wa.prototype.setLayout=function(){if(this.text){var k=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=k.layoutManager.getFreeSpace(),u=m.x1,y=m.y1,E=0,H=0,D=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,K;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=
m.width-4-D*("center"===this.horizontalAlign?2:1)),H=0.5*m.height-this.margin-2,E=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),H=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),H=0.5*m.height-4));var O;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==typeof this.padding||(O=this.padding.top?this.padding.top:this.padding.bottom?
this.padding.bottom:0,O+=this.padding.bottom?this.padding.bottom:this.padding.top?this.padding.top:0):O=2*this.padding;this.wrap||(H=Math.min(H,1.5*this.fontSize+O));H=new ha(this.ctx,{fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,fontWeight:this.fontWeight,horizontalAlign:this.horizontalAlign,verticalAlign:this.verticalAlign,borderColor:this.borderColor,borderThickness:this.borderThickness,backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,
maxHeight:H,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});O=H.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(y=m.y1+2,K="top"):"bottom"===this.verticalAlign&&(y=m.y2-2-O.height,K="bottom"),"left"===this.horizontalAlign?u=m.x1+2:"center"===this.horizontalAlign?u=m.x1+m.width/2-O.width/2:"right"===this.horizontalAlign&&(u=m.x2-2-O.width-D),N=this.horizontalAlign,this.width=O.width,this.height=O.height):"center"===
this.verticalAlign&&("left"===this.horizontalAlign?(u=m.x1+2,y=m.y2-2-(this.maxWidth/2-O.width/2),E=-90,K="left",this.width=O.height,this.height=O.width):"right"===this.horizontalAlign?(u=m.x2-2,y=m.y1+2+(this.maxWidth/2-O.width/2),E=90,K="right",this.width=O.height,this.height=O.width):"center"===this.horizontalAlign&&(y=k.y1+(k.height/2-O.height/2),u=k.x1+(k.width/2-O.width/2),K="center",this.width=O.width,this.height=O.height),N="center");H.x=u;H.y=y;H.angle=E;H.horizontalAlign=N;this._textBlock=
H;k.layoutManager.registerSpace(K,{width:this.width+("left"===K||"right"===K?this.margin+2:0),height:this.height+("top"===K||"bottom"===K?this.margin+2:0)});this.bounds={x1:u,y1:y,x2:u+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};wa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};ma(Ha,H);Ha.prototype.setLayout=wa.prototype.setLayout;Ha.prototype.render=wa.prototype.render;Ta.prototype.get=function(k,m){var s=null;0<this.pool.length?(s=this.pool.pop(),La(s,k,
m)):s=ra(k,m);return s};Ta.prototype.release=function(k){this.pool.push(k)};ma(Ia,H);var Oa={addTheme:function(k,m){ab[k]=m},addColorSet:function(k,m){xa[k]=m},addCultureInfo:function(k,m){Ja[k]=m},formatNumber:function(k,m,s){s=s||"en";if(Ja[s])return Y(k,m||"#,##0.##",new Ia(s));throw"Unknown Culture Name";},formatDate:function(k,m,s){s=s||"en";if(Ja[s])return ya(k,m||"DD MMM YYYY",new Ia(s));throw"Unknown Culture Name";}};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=
...
d),this.overlaidCanvas.style.position="absolute",this.overlaidCanvas.style.webkitTapHighlightColor="transparent",this.overlaidCanvas.style.WebkitUserSelect="none",this.overlaidCanvas.style.MozUserSelect="none",this.overlaidCanvas.style.msUserSelect="none",this.overlaidCanvas.style.userSelect="none",this.overlaidCanvas.getContext&&(this._canvasJSContainer.appendChild(this.overlaidCanvas),this.overlaidCanvasCtx=this.overlaidCanvas.getContext("2d"),this.overlaidCanvasCtx.textBaseline="top",Aa(this.overlaidCanvasCtx)),
...
K(this.overlaidCanvas,"mousemove",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mouseup",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mousedown",function(a){b._mouseEventHandler(a);sa(b._dropdownMenu)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mouseout",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerDown":"touchstart",function(a){b._touchEventHandler(a)},
this.allDOMEventHandlers),K(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerMove":"touchmove",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerUp":"touchend",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerCancel":"touchcancel",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),this.toolTip=new W(this,this.options.toolTip),
this.data=null,this.axisX=[],this.axisX2=[],this.axisY=[],this.axisY2=[],this.sessionVariables={axisX:[],axisX2:[],axisY:[],axisY2:[]})):window.console&&window.console.log('CanvasJS Error: Chart Container with id "'+this._containerId+'" was not found')}function w(a,d){for(var c=[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var f,p,l;l=e-1;f=0===l?0:l-1;p=l===a.length-1?l:l+1;b=Math.abs((a[p].x-a[f].x)/(0===a[p].x-a[l].x?0.01:a[p].x-a[l].x))*(d-1)/2+1;var A=(a[p].x-a[f].x)/b;b=(a[p].y-a[f].y)/
b;c[c.length]=a[l].x>a[f].x&&0<A||a[l].x<a[f].x&&0>A?{x:a[l].x+A/3,y:a[l].y+b/3}:{x:a[l].x,y:a[l].y+b/9};l=e;f=0===l?0:l-1;p=l===a.length-1?l:l+1;b=Math.abs((a[p].x-a[f].x)/(0===a[l].x-a[f].x?0.01:a[l].x-a[f].x))*(d-1)/2+1;A=(a[p].x-a[f].x)/b;b=(a[p].y-a[f].y)/b;c[c.length]=a[l].x>a[f].x&&0<A||a[l].x<a[f].x&&0>A?{x:a[l].x-A/3,y:a[l].y-b/3}:{x:a[l].x,y:a[l].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,p,l,A,h){var n=0;h?(p.color=f,l.color=f):h=1;n=A?Math.abs(e-c):Math.abs(b-d);n=0<p.trimLength?
...
typeof c.gridThickness||(this.gridThickness=0);this._position=f;this.lineCoordinates={x1:null,y1:null,x2:null,y2:null,width:null};this.labelAngle=(this.labelAngle%360+360)%360;90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360);this.options.scaleBreaks&&(this.scaleBreaks=new Q(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=
0;a<this.options.stripLines.length;a++)this.stripLines.push(new O(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new aa(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=null);this.hasOptionChanged("viewportMinimum")||isNaN(this.sessionVariables.newViewportMinimum)||
null===this.sessionVariables.newViewportMinimum?this.sessionVariables.newViewportMinimum=null:this.viewportMinimum=this.sessionVariables.newViewportMinimum;this.hasOptionChanged("viewportMaximum")&&null===this.viewportMaximum&&(this.options.viewportMaximum=void 0,this.sessionVariables.viewportMaximum=null);this.hasOptionChanged("viewportMaximum")||isNaN(this.sessionVariables.newViewportMaximum)||null===this.sessionVariables.newViewportMaximum?this.sessionVariables.newViewportMaximum=null:this.viewportMaximum=
this.sessionVariables.newViewportMaximum;null!==this.minimum&&null!==this.viewportMinimum&&(this.viewportMinimum=Math.max(this.viewportMinimum,this.minimum));null!==this.maximum&&null!==this.viewportMaximum&&(this.viewportMaximum=Math.min(this.viewportMaximum,this.maximum));this.trackChanges("viewportMinimum");this.trackChanges("viewportMaximum")}function Q(a,d,c,b){Q.base.constructor.call(this,"ScaleBreaks","scaleBreaks",d,null,b);this.id=c;this.chart=a;this.ctx=this.chart.ctx;this.axis=b;this.optionsName=
...
"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function W(a,d){W.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";
this._initialize()}function da(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ra(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ca(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;this.animations=[];this.animationRequestId=null}ma(m,H);m.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&this._animator.cancelAllAnimations();
...
this.updateOption("dataPointMaxWidth");this.updateOption("interactivityEnabled");this.updateOption("theme");this.updateOption("colorSet")&&(this._selectedColorSet="undefined"!==typeof xa[this.colorSet]?xa[this.colorSet]:xa.colorSet1);this.updateOption("backgroundColor");this.backgroundColor||(this.backgroundColor="rgba(0,0,0,0)");this.updateOption("culture");this._cultureInfo=new Ia(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&u;this.updateOption("animationDuration");
this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");if(this.options.zoomEnabled||this.panEnabled){if(!this._zoomButton){var d=!1;sa(this._zoomButton=document.createElement("button"));ta(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);this._zoomButton.style.borderRight=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor;K(this._zoomButton,"touchstart",
function(a){d=!0},this.allDOMEventHandlers);K(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,ta(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ta(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);K(this._zoomButton,"mouseover",function(){d?d=!1:(na(a,a._zoomButton,{backgroundColor:a.toolbar.backgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a,a._zoomButton.childNodes[0],
{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);K(this._zoomButton,"mouseout",function(){d||(na(a,a._zoomButton,{backgroundColor:a.toolbar.backgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a,a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton||(d=!1,sa(this._resetButton=document.createElement("button")),ta(this,this._resetButton,
"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.borderThickness:0)+"px solid "+this.toolbar.borderColor,this._toolBar.appendChild(this._resetButton),K(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),K(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},a.toolTip);a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,ta(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=
...
(a.stockChart._rangeEventParameter.type="rangeChanging",a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,a.stockChart));a.render();a.syncCharts&&a.syncCharts(null,null);a._dispatchRangeEvent("rangeChanged","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),K(this._resetButton,"mouseover",function(){d||(na(a,a._resetButton,{backgroundColor:a.toolbar.backgroundColorOnHover,
color:a.toolbar.hoverFfontColorOnHoverontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a,a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),K(this._resetButton,"mouseout",function(){d||(na(a,a._resetButton,{backgroundColor:a.toolbar.backgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&na(a,a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",
filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),Ka(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;eb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?ta(a,
...
this.width=d=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;if(this.canvas.width!==d*X||this.canvas.height!==c*X){for(var b=0;b<a.length;b++)La(a[b],d,c);this.bounds={x1:0,y1:0,x2:this.width,y2:this.height,width:this.width,height:this.height};a=!0}else a=!1;return a};m.prototype._initialize=function(){this.isNavigator=s(this.parent)||s(this.parent._defaultsKey)||
"Navigator"!==this.parent._defaultsKey?!1:!0;this.toolbar=new Sa(this,this.options.toolbar);this._animator?this._animator.cancelAllAnimations():this._animator=new ca(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=u&&this.animationEnabled&&0===this.renderCount;this._updateSize();this.clearCanvas();this.ctx.beginPath();this.axisX=[];this.axisX2=[];this.axisY=[];this.axisY2=
[];this._indexLabels=[];this._dataInRenderedOrder=[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ca(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new L(this,
...
this.data[a.dataSeriesIndexes[n]],q=0,g=!1,v=!1,k;if("normal"===r.axisPlacement||"xySwapped"===r.axisPlacement)var ja=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
...
b/r.dataPoints[q-1].x;1>x&&(x=1/x);c.minDiff>x&&1!==x&&(c.minDiff=x)}else x=b-r.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==r.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/r.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-r.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<ja&&!g)null!==r.dataPoints[q].y&&(k=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>t&&!v)v=!0;else if(b>t&&v)continue;r.dataPoints[q].label&&
...
q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,h))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,p=!1,l=!1,A=[],h=0;h<a.dataSeriesIndexes.length;h++){var n=this.data[a.dataSeriesIndexes[h]],r=0,q=!1,g=!1,v;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var k=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:
this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,ja=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(n.dataPoints[r].x&&n.dataPoints[r].x.getTime||"dateTime"===n.xValueType)f=
!0;for(r=0;r<n.dataPoints.length;r++){"undefined"===typeof n.dataPoints[r].x&&(n.dataPoints[r].x=r+(a.axisX.logarithmic?1:0));n.dataPoints[r].x.getTime?(f=!0,b=n.dataPoints[r].x.getTime()):b=n.dataPoints[r].x;e=s(n.dataPoints[r].y)?null:n.dataPoints[r].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<r){if(a.axisX.logarithmic){var t=b/n.dataPoints[r-1].x;1>t&&(t=1/t);c.minDiff>t&&1!==t&&(c.minDiff=t)}else t=b-n.dataPoints[r-1].x,0>t&&(t*=-1),c.minDiff>t&&0!==t&&(c.minDiff=t);s(e)||null===n.dataPoints[r-
1].y||(a.axisY.logarithmic?0<e&&(t=e/n.dataPoints[r-1].y,1>t&&(t=1/t),d.minDiff>t&&1!==t&&(d.minDiff=t)):(t=e-n.dataPoints[r-1].y,0>t&&(t*=-1),d.minDiff>t&&0!==t&&(d.minDiff=t)))}if(b<k&&!q)null!==e&&(v=b);else{if(!q&&(q=!0,0<r)){r-=2;continue}if(b>ja&&!g)g=!0;else if(b>ja&&g)continue;n.dataPoints[r].label&&(a.axisX.labels[b]=n.dataPoints[r].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&v<b&&(c.viewPortMin=v):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:
...
"xySwapped"===h.axisPlacement)var ja=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:
this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(h.dataPoints[n].x&&h.dataPoints[n].x.getTime||"dateTime"===h.xValueType)l=!0;for(n=0;n<h.dataPoints.length;n++){"undefined"===typeof h.dataPoints[n].x&&(h.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));h.dataPoints[n].x.getTime?(l=!0,b=h.dataPoints[n].x.getTime()):b=h.dataPoints[n].x;if((e=h.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);p=Math.max.apply(null,e);v=!0;for(var x=0;x<e.length;x++)null===e.k&&(v=
!1);v&&(r||(k=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);p>d.max&&(d.max=p);0<n&&(a.axisX.logarithmic?(v=b/h.dataPoints[n-1].x,1>v&&(v=1/v),c.minDiff>v&&1!==v&&(c.minDiff=v)):(v=b-h.dataPoints[n-1].x,0>v&&(v*=-1),c.minDiff>v&&0!==v&&(c.minDiff=v)),e&&(null!==e[0]&&h.dataPoints[n-1].y&&null!==h.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(v=e[0]/h.dataPoints[n-1].y[0],1>v&&(v=1/v),d.minDiff>v&&1!==v&&(d.minDiff=v)):(v=e[0]-h.dataPoints[n-1].y[0],0>v&&(v*=-1),d.minDiff>v&&0!==
v&&(d.minDiff=v))));if(!(b<ja)||r){if(!r&&(r=!0,0<n)){n-=2;g=k;continue}if(b>t&&!q)q=!0;else if(b>t&&q)continue;h.dataPoints[n].label&&(a.axisX.labels[b]=h.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),p>d.viewPortMax&&(d.viewPortMax=p))}}h.axisX.valueType=h.xValueType=l?"dateTime":
...
n,r,f=[];if(this._axes[p].dataInfo.dataPointYPositiveSums){var q=this._axes[p].dataInfo.dataPointYPositiveSums;n=h;for(l in q)if(q.hasOwnProperty(l)&&!isNaN(l)&&(r=q[l],!s(r))){var g=Math.floor((r-A)/b);r<n[g].min&&(n[g].min=r);r>n[g].max&&(n[g].max=r)}delete this._axes[p].dataInfo.dataPointYPositiveSums}if(this._axes[p].dataInfo.dataPointYNegativeSums){q=this._axes[p].dataInfo.dataPointYNegativeSums;n=h;for(l in q)q.hasOwnProperty(l)&&!isNaN(l)&&(r=-1*q[l],s(r)||(g=Math.floor((r-A)/b),r<n[g].min&&
...
1;0<=e;e--){var f=null;(f=this._dataInRenderedOrder[e].getDataPointAtXY(a,d,c))&&b.push(f)}a=null;d=!1;for(c=0;c<b.length;c++)if("line"===b[c].dataSeries.type||"stepLine"===b[c].dataSeries.type||"area"===b[c].dataSeries.type||"stepArea"===b[c].dataSeries.type)if(e=ga("markerSize",b[c].dataPoint,b[c].dataSeries)||8,b[c].distance<=e/2){d=!0;break}for(c=0;c<b.length;c++)d&&"line"!==b[c].dataSeries.type&&"stepLine"!==b[c].dataSeries.type&&"area"!==b[c].dataSeries.type&&"stepArea"!==b[c].dataSeries.type||
(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(u)b=Ya(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=jb;m.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};
m.prototype.clearCanvas=ib;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=Na(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;case "touchend":case "MSPointerUp":var f=this._lastTouchData&&this._lastTouchData.time?
...
a.target!==b.chart.overlaidCanvas&&u||b[c].call(b.context,d.x,d.y):a.target!==b.chart.overlaidCanvas&&(b.chart.isDrag=!1)));if(this.interactivityEnabled)if(this._ignoreNextEvent)this._ignoreNextEvent=!1;else if(a.preventManipulation&&a.preventManipulation(),a.preventDefault&&a.preventDefault(),Ga&&window.console&&(window.console.log(c+" --\x3e x: "+d.x+"; y:"+d.y),e&&window.console.log(a.which),"mouseup"===c&&window.console.log("mouseup")),!e){if(!m.capturedEventParam&&this._events){for(var f=0;f<
this._events.length;f++)if(this._events[f].hasOwnProperty(c))if(b=this._events[f],e=b.bounds,d.x>=e.x1&&d.x<=e.x2&&d.y>=e.y1&&d.y<=e.y2){b[c].call(b.context,d.x,d.y);"mousedown"===c&&!0===b.capture?(m.capturedEventParam=b,this.overlaidCanvas.setCapture?this.overlaidCanvas.setCapture():document.documentElement.addEventListener("mouseup",this._mouseEventHandler,!1)):"mouseup"===c&&(b.chart.overlaidCanvas.releaseCapture?b.chart.overlaidCanvas.releaseCapture():document.documentElement.removeEventListener("mouseup",
this._mouseEventHandler,!1));break}else b=null;a.target.style.cursor=b&&b.cursor?b.cursor:this._defaultCursor}c=this.plotArea;if(d.x<c.x1||d.x>c.x2||d.y<c.y1||d.y>c.y2)if(this.toolTip&&this.toolTip.enabled){this.toolTip.hide();this.toolTip.dispatchEvent("hidden",{chart:this,toolTip:this.toolTip},this.toolTip);for(f=0;f<this.axisX.length;f++)this.axisX[f].crosshair&&this.axisX[f].crosshair.enabled&&this.axisX[f].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisX[f].options},this.axisX[f].crosshair);
for(f=0;f<this.axisX2.length;f++)this.axisX2[f].crosshair&&this.axisX2[f].crosshair.enabled&&this.axisX2[f].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisX2[f].options},this.axisX2[f].crosshair);for(f=0;f<this.axisY.length;f++)this.axisY[f].crosshair&&this.axisY[f].crosshair.enabled&&this.axisY[f].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisY[f].options},this.axisY[f].crosshair);for(f=0;f<this.axisY2.length;f++)this.axisY2[f].crosshair&&this.axisY2[f].crosshair.enabled&&
this.axisY2[f].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisY2[f].options},this.axisY2[f].crosshair)}else this.resetOverlayedCanvas();this.isDrag&&this.zoomEnabled||!this._eventManager||this._eventManager.mouseEventHandler(a)}};m.prototype._plotAreaMouseDown=function(a,d){this.isDrag=!0;this.dragStartPoint={x:a,y:d}};m.prototype._plotAreaMouseUp=function(a,d){if(("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)&&this.isDrag){var c=d-this.dragStartPoint.y,
b=a-this.dragStartPoint.x,e=0<=this.zoomType.indexOf("x"),f=0<=this.zoomType.indexOf("y"),p=!1;this.resetOverlayedCanvas();if("xySwapped"===this.plotInfo.axisPlacement)var l=f,f=e,e=l;if(this.panEnabled||this.zoomEnabled){if(this.panEnabled)for(e=f=0;e<this._axes.length;e++)c=this._axes[e],c.logarithmic?c.viewportMinimum<c.minimum?(f=c.minimum/c.viewportMinimum,c.sessionVariables.newViewportMinimum=c.viewportMinimum*f,c.sessionVariables.newViewportMaximum=c.viewportMaximum*f,p=!0):c.viewportMaximum>
...
"rangeChanging",this.stockChart.dispatchEvent("rangeChanging",this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),p&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ka(this._zoomButton,
this._resetButton),ta(this,this._zoomButton,"pan"),ta(this,this._resetButton,"reset")))}}this.isDrag=!1;if("none"!==this.plotInfo.axisPlacement){this.resetOverlayedCanvas();if(this.axisX&&0<this.axisX.length)for(p=0;p<this.axisX.length;p++)this.axisX[p].crosshair&&this.axisX[p].crosshair.enabled&&this.axisX[p].renderCrosshair(a,d);if(this.axisX2&&0<this.axisX2.length)for(p=0;p<this.axisX2.length;p++)this.axisX2[p].crosshair&&this.axisX2[p].crosshair.enabled&&this.axisX2[p].renderCrosshair(a,d);if(this.axisY&&
...
{stockChart:this.stockChart,source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};m.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var f=0<=this.zoomType.indexOf("x"),p=0<=this.zoomType.indexOf("y"),l=!1,A=[],h=[],n=[],r=0;r<this._axes.length;r++)("axisX"===this._axes[r].type&&f||"axisY"===this._axes[r].type&&p)&&h.push(this._axes[r]);for(p=0;p<h.length;p++){var r=h[p],f=!1,q=r.convertPixelToValue({x:a,y:d}),g=r.convertPixelToValue({x:c,
y:b});if(q>g)var v=g,g=q,q=v;if(r.scaleBreaks)for(v=0;!f&&v<r.scaleBreaks._appliedBreaks.length;v++)f=r.scaleBreaks._appliedBreaks[v].startValue<=q&&r.scaleBreaks._appliedBreaks[v].endValue>=g;if(isFinite(r.dataInfo.minDiff))if(v=r.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&r.scaleBreaks&&r.scaleBreaks._appliedBreaks.length)&&(r.logarithmic&&v<Math.pow(r.dataInfo.minDiff,3)||!r.logarithmic&&v<3*Math.abs(r.dataInfo.minDiff))||q<r.minimum||g>r.maximum))A.push(r),n.push({val1:q,val2:g}),
l=!0;else if(!e){l=!1;break}}return{isValid:l,axesWithValidRange:A,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!u&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;if(this.axisY&&0<this.axisY.length&&this.axisY[0]){var c=this.axisY[0];a.x1=d.x1<d.x2?d.x1:c.lineCoordinates.x1;a.y1=d.y1<c.lineCoordinates.y1?d.y1:c.lineCoordinates.y1;
...
d.y1,a.y2=d.y2,a.width=d.width,a.height=d.height;u||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ca(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,p=0,l=b=p=e=f=0,A=0;for(a=0;a<this._indexLabels.length;a++){var h=this._indexLabels[a],n=h.chartType.toLowerCase(),r,q,l=ga("indexLabelFontColor",h.dataPoint,
h.dataSeries),A=ga("indexLabelFontSize",h.dataPoint,h.dataSeries);r=ga("indexLabelFontFamily",h.dataPoint,h.dataSeries);q=ga("indexLabelFontStyle",h.dataPoint,h.dataSeries);var p=ga("indexLabelFontWeight",h.dataPoint,h.dataSeries),g=ga("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),e=ga("indexLabelMaxWidth",h.dataPoint,h.dataSeries),f=ga("indexLabelWrap",h.dataPoint,h.dataSeries),v=ga("indexLabelLineDashType",h.dataPoint,h.dataSeries),k=ga("indexLabelLineColor",h.dataPoint,h.dataSeries),m=
...
-A))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)h=this._indexLabels[a],g=ga("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),h.dataSeries.indexLabelBackgroundColor=s(g)?u?"transparent":null:g;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
B=R(B);u&&f.push({x:x,y:s,ctx:b,type:C.type,size:C.size,color:B,borderColor:B,borderThickness:C.borderThickness})}(n[t].indexLabel||h.indexLabel||n[t].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:h,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:v})}c.stroke();u&&b.stroke()}}V.drawMarkers(f);u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||
this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],p,l=0;l<a.dataSeriesIndexes.length;l++){var A=a.dataSeriesIndexes[l],h=this.data[A];c.lineWidth=h.lineThickness;var n=h.dataPoints,r="solid";if(c.setLineDash){var q=N(h.nullDataLineDashType,h.lineThickness),r=h.lineDashType,g=N(r,h.lineThickness);c.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]=
{objectType:"dataSeries",dataSeriesIndex:A};v=R(v);b.strokeStyle=v;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var F=!1,t=0;t<n.length;t++)if(x=n[t].getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!F)))if("number"!==typeof n[t].y)0<t&&!(h.connectNullData||F||m)&&(c.stroke(),
...
(r=h.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<h.markerSize)B=h.getMarkerProperties(t,x,s,c),f.push(B),C=R(C),u&&f.push({x:x,y:s,ctx:b,type:B.type,size:B.size,color:C,borderColor:C,borderThickness:B.borderThickness});(n[t].indexLabel||h.indexLabel||n[t].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:h,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:v})}c.stroke();u&&b.stroke()}}V.drawMarkers(f);u&&
(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,
easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=w(a,2);if(0<a.length){b.beginPath();u&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);u&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),u&&e.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),
...
b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var p=[],l=0;l<a.dataSeriesIndexes.length;l++){var A=a.dataSeriesIndexes[l],h=this.data[A];b.lineWidth=h.lineThickness;var n=h.dataPoints,r="solid";if(b.setLineDash){var q=N(h.nullDataLineDashType,h.lineThickness),r=h.lineDashType,g=N(r,h.lineThickness);b.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=R(v);e.strokeStyle=v;e.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,
...
g)));if(0<n[m].markerSize||0<h.markerSize){var B=h.getMarkerProperties(m,t,x,b);p.push(B);F=R(F);u&&p.push({x:t,y:x,ctx:e,type:B.type,size:B.size,color:F,borderColor:F,borderThickness:B.borderThickness})}(n[m].indexLabel||h.indexLabel||n[m].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:h,point:{x:t,y:x},direction:0>n[m].y===a.axisY.reversed?1:-1,color:v});x=!1}d(s)}V.drawMarkers(p);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,
...
A=v[f].x,!(A<a.axisX.dataInfo.viewPortMin||A>a.axisX.dataInfo.viewPortMax)&&"number"===typeof v[f].y){p=a.axisX.convertValueToPixel(A);l=a.axisY.convertValueToPixel(v[f].y);p=a.axisX.reversed?p+a.plotType.totalDataSeries*r/2-(a.previousDataSeriesCount+n)*r<<0:p-a.plotType.totalDataSeries*r/2+(a.previousDataSeriesCount+n)*r<<0;var m=a.axisX.reversed?p-r<<0:p+r<<0,t;0<=v[f].y?t=h:(t=l,l=h);l>t&&(b=l,l=t,t=b);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];Z(c,p,l,m,t,b,0,null,k&&0<=v[f].y,
0>v[f].y&&k,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:p,y1:l,x2:m,y2:t};b=R(b);u&&Z(this._eventManager.ghostCtx,p,l,m,t,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||g.indexLabel||v[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:v[f],dataSeries:g,point:{x:p+(m-p)/2,y:0>v[f].y===a.axisY.reversed?l:t},direction:0>v[f].y===a.axisY.reversed?1:-1,bounds:{x1:p,
...
return{source:d,dest:this.plotArea.ctx,animationCallback:J.yScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:h<a.axisY.bounds.y1?a.axisY.bounds.y1:h>a.axisY.bounds.y2?a.axisY.bounds.y2:h}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],l=[],A=[],h=0,n,r,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?
...
B="undefined"!==typeof f[b]?f[b]:q,f[b]=r);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=t[h].y+(A[b]?A[b]:0),B=a.axisY.convertValueToPixel(A[b]),r="undefined"!==typeof p[b]?p[b]:q,p[b]=B;else if(r=a.axisY.convertValueToPixel(t[h].y),0<=t[h].y){var C="undefined"!==typeof f[b]?f[b]:0;r-=C;B=q-C;f[b]=C+(B-r)}else C=p[b]?p[b]:0,B=r+C,r=q+C,p[b]=C+(B-r);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];Z(c,s,r,F,B,b,0,null,x&&0<=t[h].y,0>t[h].y&&x,!1,
!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:s,y1:r,x2:F,y2:B};b=R(b);u&&Z(this._eventManager.ghostCtx,s,r,F,B,b,0,null,!1,!1,!1,!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[h],dataSeries:m,point:{x:n,y:0<=t[h].y?r:B},direction:0>t[h].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(r,B),x2:F,y2:Math.max(r,
...
animationCallback:J.yScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],l=[],A=[],h=0,n,r,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:
...
p[b]:0,B=r+C,r=q+C,a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.y2-B)&&(B=e.y2),p[b]=C+(B-r);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];Z(c,s,r,F,B,b,0,null,x&&0<=t[h].y,0>t[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:s,y1:r,x2:F,y2:B};b=R(b);u&&Z(this._eventManager.ghostCtx,s,r,F,B,b,0,null,!1,!1,!1,!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&
...
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.yScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
p=a.axisY.convertValueToPixel(v[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*r/2-(a.previousDataSeriesCount+n)*r<<0:l-a.plotType.totalDataSeries*r/2+(a.previousDataSeriesCount+n)*r<<0;var m=a.axisX.reversed?l-r<<0:l+r<<0,t;0<=v[f].y?t=h:(t=p,p=h);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];Z(c,t,l,p,m,b,0,null,k,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:t,y1:l,x2:p,y2:m};b=R(b);
u&&Z(this._eventManager.ghostCtx,t,l,p,m,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||g.indexLabel||v[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:v[f],dataSeries:g,point:{x:0<=v[f].y?p:t,y:l+(m-l)/2},direction:0>v[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(t,p),y1:l,x2:Math.max(t,p),y2:m},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.xScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:h<a.axisY.bounds.x1?a.axisY.bounds.x1:h>a.axisY.bounds.x2?a.axisY.bounds.x2:
...
h&&(g=h);g>r&&(g=r);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<t.length;h++)if(b=t[h].x.getTime?t[h].x.getTime():
t[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[h].y){r=a.axisX.convertValueToPixel(b);var z=r-a.plotType.plotUnits.length*g/2+a.index*g<<0,F=z+g<<0,B;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[h].y)l[b]=t[h].y+(l[b]?l[b]:0),0<l[b]&&(B=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(l[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=t[h].y+(A[b]?A[b]:0),n=p[b]?
p[b]:q,p[b]=B=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(t[h].y),0<=t[h].y){var C=f[b]?f[b]:0;B=q+C;n+=C;f[b]=C+(n-B)}else C=p[b]?p[b]:0,B=n-C,n=q-C,p[b]=C+(n-B);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];Z(c,B,z,n,F,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:B,y1:z,x2:n,y2:F};b=R(b);u&&Z(this._eventManager.ghostCtx,B,z,n,F,b,0,null,!1,!1,!1,!1);
(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[h],dataSeries:m,point:{x:0<=t[h].y?n:B,y:r},direction:0>t[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(B,n),y1:z,x2:Math.max(B,n),y2:F},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.xScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],p=[],l=[],A=[],h=0,n,r,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;r=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=
this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>r&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,r));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&r<h)&&(r=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>r&&(g=r);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();
c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<t.length;h++)if(b=t[h].x.getTime?t[h].x.getTime():t[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===
typeof t[h].y){r=a.axisX.convertValueToPixel(b);var z;z=0!==a.dataPointYSums[b]?100*(t[h].y/a.dataPointYSums[b]):0;var F=r-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=F+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[h].y){l[b]=z+(l[b]?l[b]:0);if(0>=l[b])continue;z=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(l[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=z+(A[b]?A[b]:0),n=p[b]?p[b]:q,p[b]=z=a.axisY.convertValueToPixel(A[b]);
else if(n=a.axisY.convertValueToPixel(z),0<=t[h].y){var C=f[b]?f[b]:0;z=q+C;n+=C;a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=C+(n-z)}else C=p[b]?p[b]:0,z=n-C,n=q-C,a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.x1-z)&&(z=e.x1),p[b]=C+(n-z);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];Z(c,z,F,n,B,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:z,y1:F,x2:n,
y2:B};b=R(b);u&&Z(this._eventManager.ghostCtx,z,F,n,B,b,0,null,!1,!1,!1,!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[h],dataSeries:m,point:{x:0<=t[h].y?n:z,y:r},direction:0>t[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,n),y1:F,x2:Math.max(z,n),y2:B},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.xScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:
q}}};m.prototype.renderArea=function(a){var d,c;function b(){B&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?F=z:0>a.axisY.viewportMaximum?F=l.y1:0<a.axisY.viewportMinimum&&(F=z),f.lineTo(m,F),f.lineTo(B.x,F),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(p.lineTo(m,F),p.lineTo(B.x,F),p.closePath(),p.fill()),f.beginPath(),f.moveTo(m,t),p.beginPath(),p.moveTo(m,t),B={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,
f=u?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var p=this._eventManager.ghostCtx,l=a.axisY.lineCoordinates,A=[],h=this.plotArea,n;f.save();u&&p.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();u&&(p.beginPath(),p.rect(h.x1,h.y1,h.width,h.height),p.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var q=a.dataSeriesIndexes[r],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=R(A);p.fillStyle=A;A=[];
d=!0;var k=0,m,t,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),F,B=null;if(0<v.length){var C=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||C,y=w;f.fillStyle=C;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var T=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var S=N(c,g.lineThickness);f.setLineDash(S)}for(var ia=!0;k<v.length;k++)if(s=v[k].x.getTime?v[k].x.getTime():v[k].x,!(s<a.axisX.dataInfo.viewPortMin||
s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ia)))if("number"!==typeof v[k].y)g.connectNullData||(ia||d)||b(),ia=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(v[k].y);d||ia?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,B=n,c=g.nullDataLineDashType,f.setLineDash(T)),f.lineTo(m,t),u&&p.lineTo(m,t)):(f.beginPath(),f.moveTo(m,t),u&&
(p.beginPath(),p.moveTo(m,t)),B={x:m,y:t}),ia=d=!1):(f.lineTo(m,t),u&&p.lineTo(m,t),0==k%250&&b());n={x:m,y:t};k<v.length-1&&(y!==(v[k].lineColor||w)||c!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(c=v[k].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(S))));var $=g.dataPointIds[k];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:t};0!==v[k].markerSize&&
(0<v[k].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(k,m,t,f),A.push(s),$=R($),u&&A.push({x:m,y:t,ctx:p,type:s.type,size:s.size,color:$,borderColor:$,borderThickness:s.borderThickness}));(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:v[k],dataSeries:g,point:{x:m,y:t},direction:0>v[k].y===a.axisY.reversed?1:-1,color:C})}b();V.drawMarkers(A)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};
...
b.clip();u&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var A=0;A<a.dataSeriesIndexes.length;A++){var h=a.dataSeriesIndexes[A],n=this.data[h],r=n.dataPoints,p=n.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:h};p=R(p);e.fillStyle=p;var p=[],q=0,g,v,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,t=null,s=[];if(0<r.length){var z=n._colorSet[q%n._colorSet.length],F=n.lineColor=n.options.lineColor||z,B=F;b.fillStyle=z;b.strokeStyle=
...
C=n.nullDataLineDashType):(d(),s=[])),v=!0;else{g=a.axisX.convertValueToPixel(g);v=a.axisY.convertValueToPixel(r[q].y);var T=n.dataPointIds[q];this._eventManager.objectMap[T]={id:T,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:q,x1:g,y1:v};s[s.length]={x:g,y:v};q<r.length-1&&(B!==(r[q].lineColor||F)||C!==(r[q].lineDashType||n.lineDashType))&&(B=r[q].lineColor||F,s[s.length-1].newStrokeStyle=B,b.setLineDash&&(r[q].lineDashType?(C=r[q].lineDashType,s[s.length-1].newLineDashArray=N(C,n.lineThickness)):
(C=n.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==r[q].markerSize&&(0<r[q].markerSize||0<n.markerSize)){var S=n.getMarkerProperties(q,g,v,b);p.push(S);T=R(T);u&&p.push({x:g,y:v,ctx:e,type:S.type,size:S.size,color:T,borderColor:T,borderThickness:S.borderThickness})}(r[q].indexLabel||n.indexLabel||r[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:r[q],dataSeries:n,point:{x:g,y:v},direction:0>r[q].y===a.axisY.reversed?1:-1,color:z});
v=!1}d();V.drawMarkers(p)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,
dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){B&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?F=z:0>a.axisY.viewportMaximum?F=l.y1:0<a.axisY.viewportMinimum&&(F=z),f.lineTo(m,F),f.lineTo(B.x,F),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(p.lineTo(m,F),p.lineTo(B.x,F),p.closePath(),p.fill()),
...
A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=R(A);p.fillStyle=A;A=[];d=!0;var k=0,m,t,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),F,B=null;c=!1;if(0<v.length){var C=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||C,y=w;f.fillStyle=C;f.strokeStyle=w;f.lineWidth=g.lineThickness;var T="solid";if(f.setLineDash){var S=N(g.nullDataLineDashType,g.lineThickness),T=g.lineDashType,D=N(T,g.lineThickness);f.setLineDash(D)}for(;k<
v.length;k++)if(s=v[k].x.getTime?v[k].x.getTime():v[k].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=t;"number"!==typeof v[k].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),t=a.axisY.convertValueToPixel(v[k].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||T===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,B=n,T=g.nullDataLineDashType,
f.setLineDash(S)),f.lineTo(m,$),f.lineTo(m,t),u&&(p.lineTo(m,$),p.lineTo(m,t))):(f.beginPath(),f.moveTo(m,t),u&&(p.beginPath(),p.moveTo(m,t)),B={x:m,y:t}),c=d=!1):(f.lineTo(m,$),u&&p.lineTo(m,$),f.lineTo(m,t),u&&p.lineTo(m,t),0==k%250&&b()),n={x:m,y:t},k<v.length-1&&(y!==(v[k].lineColor||w)||T!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(T=v[k].lineDashType,f.setLineDash(N(T,g.lineThickness))):(T=g.lineDashType,f.setLineDash(D)))),
s=g.dataPointIds[k],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:t},0!==v[k].markerSize&&(0<v[k].markerSize||0<g.markerSize)&&($=g.getMarkerProperties(k,m,t,f),A.push($),s=R(s),u&&A.push({x:m,y:t,ctx:p,type:$.type,size:$.size,color:s,borderColor:s,borderThickness:$.borderThickness})),(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:v[k],dataSeries:g,point:{x:m,
y:t},direction:0>v[k].y===a.axisY.reversed?1:-1,color:C}))}b();V.drawMarkers(A)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());
f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>h.length)){for(0<C.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);u&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(s.closePath(),s.fill(),s.beginPath());h=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:
...
[];for(q=0;q<w.length;q++)B=w[q].x.getTime?w[q].x.getTime():w[q].x,C.dataPointIndexes[B]=q,e[B]||(n.push(B),e[B]=!0);n.sort(Pa)}for(F=0;F<a.dataSeriesIndexes.length;F++){B=a.dataSeriesIndexes[F];C=this.data[B];w=C.dataPoints;x=!0;h=[];q=C.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:B};q=R(q);s.fillStyle=q;if(0<n.length){var e=C._colorSet[0],y=C.lineColor=C.options.lineColor||e,T=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=C.lineThickness;z="solid";if(b.setLineDash){var S=
N(C.nullDataLineDashType,C.lineThickness);z=C.lineDashType;var D=N(z,C.lineThickness);b.setLineDash(D)}for(var $=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=C.dataPointIndexes[f]?w[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!$)))if("number"!==typeof ea.y)C.connectNullData||($||x)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var ka=A[f]?A[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){r[f]=
ea.y+(r[f]?r[f]:0);if(0>=r[f]&&a.axisY.logarithmic)continue;k=a.axisY.convertValueToPixel(r[f])}else k=a.axisY.convertValueToPixel(ea.y),k-=ka;h.push({x:g,y:m-ka});A[f]=m-k;x||$?(!x&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||z===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(x=h.pop(),z=h[h.length-1],d(),b.moveTo(t.x,t.y),h.push(z),h.push(x),z=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,k),u&&s.lineTo(g,k)):(b.beginPath(),b.moveTo(g,k),u&&(s.beginPath(),
s.moveTo(g,k))),$=x=!1):(b.lineTo(g,k),u&&s.lineTo(g,k),0==q%250&&(d(),b.moveTo(g,k),u&&s.moveTo(g,k),h.push({x:g,y:m-ka})));t={x:g,y:k};q<w.length-1&&(T!==(w[q].lineColor||y)||z!==(w[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,k),h.push({x:g,y:m-ka}),T=w[q].lineColor||y,b.strokeStyle=T,b.setLineDash&&(w[q].lineDashType?(z=w[q].lineDashType,b.setLineDash(N(z,C.lineThickness))):(z=C.lineDashType,b.setLineDash(D))));if(0<=C.dataPointIndexes[f]){var E=C.dataPointIds[C.dataPointIndexes[f]];
this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:k}}0<=C.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<C.markerSize)&&(ka=C.getMarkerProperties(C.dataPointIndexes[f],g,k,b),p.push(ka),f=R(E),u&&p.push({x:g,y:k,ctx:s,type:ka.type,size:ka.size,color:f,borderColor:f,borderThickness:ka.borderThickness}));(ea.indexLabel||C.indexLabel||ea.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",
dataPoint:ea,dataSeries:C,point:{x:g,y:k},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,k);u&&s.moveTo(g,k)}delete C.dataPointIndexes}V.drawMarkers(p);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<C.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);u&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(z.closePath(),z.fill(),z.beginPath());h=[]}
var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,p=this.plotArea,l=[],k=[],h=[],n=[],r=[],q=0,g,v,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();u&&z.save();b.beginPath();b.rect(p.x1,p.y1,p.width,p.height);b.clip();u&&(z.beginPath(),z.rect(p.x1,p.y1,p.width,p.height),z.clip());for(var e=[],F=0;F<a.dataSeriesIndexes.length;F++){var B=a.dataSeriesIndexes[F],
C=this.data[B],w=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<w.length;q++)B=w[q].x.getTime?w[q].x.getTime():w[q].x,C.dataPointIndexes[B]=q,e[B]||(n.push(B),e[B]=!0);n.sort(Pa)}for(F=0;F<a.dataSeriesIndexes.length;F++){B=a.dataSeriesIndexes[F];C=this.data[B];w=C.dataPoints;s=!0;e=C.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:B};e=R(e);z.fillStyle=e;h=[];if(0<n.length){var e=C._colorSet[q%C._colorSet.length],y=C.lineColor=C.options.lineColor||e,T=y;b.fillStyle=e;b.strokeStyle=
y;b.lineWidth=C.lineThickness;t="solid";if(b.setLineDash){var S=N(C.nullDataLineDashType,C.lineThickness);t=C.lineDashType;var D=N(t,C.lineThickness);b.setLineDash(D)}for(var $=!0,q=0;q<n.length;q++){var f=n[q],ea=null,ea=0<=C.dataPointIndexes[f]?w[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!$)))if("number"!==typeof ea.y)C.connectNullData||($||s)||d(),$=!0;else{var ka;ka=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):
0;g=a.axisX.convertValueToPixel(f);var E=k[f]?k[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){r[f]=ka+(r[f]?r[f]:0);if(0>=r[f]&&a.axisY.logarithmic)continue;v=a.axisY.convertValueToPixel(r[f])}else v=a.axisY.convertValueToPixel(ka),v-=E;h.push({x:g,y:x-E});k[f]=x-v;s||$?(!s&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||t===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(s=h.pop(),t=h[h.length-1],d(),b.moveTo(m.x,m.y),
h.push(t),h.push(s),t=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,v),u&&z.lineTo(g,v)):(b.beginPath(),b.moveTo(g,v),u&&(z.beginPath(),z.moveTo(g,v))),$=s=!1):(b.lineTo(g,v),u&&z.lineTo(g,v),0==q%250&&(d(),b.moveTo(g,v),u&&z.moveTo(g,v),h.push({x:g,y:x-E})));m={x:g,y:v};q<w.length-1&&(T!==(w[q].lineColor||y)||t!==(w[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,v),h.push({x:g,y:x-E}),T=w[q].lineColor||y,b.strokeStyle=T,b.setLineDash&&(w[q].lineDashType?(t=w[q].lineDashType,
b.setLineDash(N(t,C.lineThickness))):(t=C.lineDashType,b.setLineDash(D))));if(0<=C.dataPointIndexes[f]){var G=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:v}}0<=C.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<C.markerSize)&&(E=C.getMarkerProperties(q,g,v,b),l.push(E),f=R(G),u&&l.push({x:g,y:v,ctx:z,type:E.type,size:E.size,color:f,borderColor:f,borderThickness:E.borderThickness}));
(ea.indexLabel||C.indexLabel||ea.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:C,point:{x:g,y:v},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,v);u&&z.moveTo(g,v)}delete C.dataPointIndexes}V.drawMarkers(l);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(p.x1,p.y1,p.width,p.height),z.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,p;c.save();u&&this._eventManager.ghostCtx.save();
...
p.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var ja=a.dataSeriesIndexes[m],t=this.data[ja],x=t.dataPoints;if(0<x.length)for(var z=5<v&&t.bevelEnabled?!0:!1,l=0;l<x.length;l++)if(x[l].getTime?g=x[l].x.getTime():g=x[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[l].y)&&x[l].y.length&&"number"===typeof x[l].y[0]&&"number"===typeof x[l].y[1]&&"number"===typeof x[l].y[2]&&"number"===typeof x[l].y[3]){k=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[l].y[0]);
n=a.axisY.convertValueToPixel(x[l].y[1]);r=a.axisY.convertValueToPixel(x[l].y[2]);q=a.axisY.convertValueToPixel(x[l].y[3]);var w=k-v/2<<0,B=w+v<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[l].color?x[l].color:t._colorSet[0],C=Math.round(Math.max(1,0.15*v)),y=0===C%2?0:0.5,D=t.dataPointIds[l];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:ja,dataPointIndex:l,x1:w,y1:h,x2:B,y2:n,x3:k,y3:r,x4:k,y4:q,borderThickness:C,color:e};c.strokeStyle=e;c.beginPath();
c.lineWidth=C;b.lineWidth=Math.max(C,4);"candlestick"===t.type?(c.moveTo(k-y,n),c.lineTo(k-y,Math.min(h,q)),c.stroke(),c.moveTo(k-y,Math.max(h,q)),c.lineTo(k-y,r),c.stroke(),Z(c,w,Math.min(h,q),B,Math.max(h,q),x[l].y[0]<=x[l].y[3]?t.risingColor:f,C,e,z,z,!1,!1,t.fillOpacity),u&&(e=R(D),b.strokeStyle=e,b.moveTo(k-y,n),b.lineTo(k-y,Math.min(h,q)),b.stroke(),b.moveTo(k-y,Math.max(h,q)),b.lineTo(k-y,r),b.stroke(),Z(b,w,Math.min(h,q),B,Math.max(h,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(k-
y,n),c.lineTo(k-y,r),c.stroke(),c.beginPath(),c.moveTo(k,h),c.lineTo(w,h),c.stroke(),c.beginPath(),c.moveTo(k,q),c.lineTo(B,q),c.stroke(),u&&(e=R(D),b.strokeStyle=e,b.moveTo(k-y,n),b.lineTo(k-y,r),b.stroke(),b.beginPath(),b.moveTo(k,h),b.lineTo(w,h),b.stroke(),b.beginPath(),b.moveTo(k,q),b.lineTo(B,q),b.stroke()));(x[l].indexLabel||t.indexLabel||x[l].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:x[l],dataSeries:t,point:{x:w+(B-w)/2,y:a.axisY.reversed?
r:n},direction:1,bounds:{x1:w,y1:Math.min(n,r),x2:B,y2:Math.max(n,r)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(p.x1,p.y1,p.width,p.height),b.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,p=0,l,k,h,n,r,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,p=this.options.dataPointMaxWidth?
...
0.15*v)),D=0===y%2?0:0.5,T=z[p].whiskerColor?z[p].whiskerColor:z[p].color?x.whiskerColor?x.whiskerColor:z[p].color:x.whiskerColor?x.whiskerColor:e,S="number"===typeof z[p].whiskerThickness?z[p].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,E=z[p].whiskerDashType?z[p].whiskerDashType:x.whiskerDashType,$=s(z[p].whiskerLength)?s(x.options.whiskerLength)?v:x.whiskerLength:z[p].whiskerLength,$="number"===typeof $?0>=$?0:$>=v?v:$:"string"===typeof $?parseInt($)*v/100>
v?v:parseInt($)*v/100:v,ea=1===Math.round(S)%2?0.5:0,ka=z[p].stemColor?z[p].stemColor:z[p].color?x.stemColor?x.stemColor:z[p].color:x.stemColor?x.stemColor:e,za="number"===typeof z[p].stemThickness?z[p].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(za)%2?0.5:0,H=z[p].stemDashType?z[p].stemDashType:x.stemDashType,K=z[p].lineColor?z[p].lineColor:z[p].color?x.lineColor?x.lineColor:z[p].color:x.lineColor?x.lineColor:e,L="number"===typeof z[p].lineThickness?
z[p].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,O=z[p].lineDashType?z[p].lineDashType:x.lineDashType,M=1===Math.round(L)%2?0.5:0,Q=x.upperBoxColor,ua=x.lowerBoxColor,qa=s(x.options.fillOpacity)?1:x.fillOpacity,P=x.dataPointIds[p];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:p,x1:B,y1:k,x2:C,y2:h,x3:l,y3:n,x4:l,y4:r,y5:q,borderThickness:y,color:e,stemThickness:za,stemColor:ka,whiskerThickness:S,whiskerLength:$,whiskerColor:T,
lineThickness:L,lineColor:K};c.save();0<za&&(c.beginPath(),c.strokeStyle=ka,c.lineWidth=za,c.setLineDash&&c.setLineDash(N(H,za)),c.moveTo(l-G,h),c.lineTo(l-G,k),c.stroke(),c.moveTo(l-G,r),c.lineTo(l-G,n),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();Z(c,B,Math.min(q,h),C,Math.max(h,q),ua,0,e,m?F:!1,m?!1:F,!1,!1,qa);c.beginPath();Z(c,B,Math.min(n,q),C,Math.max(q,n),Q,0,e,m?!1:F,m?F:!1,!1,!1,qa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(B-D,Math.min(h,n)-D,C-B+2*D,Math.max(h,
n)-Math.min(h,n)+2*D);c.stroke();c.save();0<L&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(O,L)),c.strokeStyle=K,c.lineWidth=L,c.moveTo(B,q-M),c.lineTo(C,q-M),c.stroke());c.restore();c.save();0<S&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(E,S)),c.strokeStyle=T,c.lineWidth=S,c.moveTo(l-$/2<<0,r-ea),c.lineTo(l+$/2<<0,r-ea),c.stroke(),c.moveTo(l-$/2<<0,k+ea),c.lineTo(l+$/2<<0,k+ea),c.stroke());c.restore();u&&(e=R(P),b.strokeStyle=e,b.lineWidth=za,0<za&&(b.moveTo(l-D-G,h),b.lineTo(l-
D-G,Math.max(k,r)),b.stroke(),b.moveTo(l-D-G,Math.min(k,r)),b.lineTo(l-D-G,n),b.stroke()),Z(b,B,Math.max(h,n),C,Math.min(h,n),e,0,null,!1,!1,!1,!1),0<S&&(b.beginPath(),b.lineWidth=S,b.moveTo(l+$/2,r-ea),b.lineTo(l-$/2,r-ea),b.stroke(),b.moveTo(l+$/2,k+ea),b.lineTo(l-$/2,k+ea),b.stroke()));(z[p].indexLabel||x.indexLabel||z[p].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:z[p],dataSeries:x,point:{x:B+(C-B)/2,y:a.axisY.reversed?k:r},direction:1,bounds:{x1:B,
...
k>a.axisX.dataInfo.viewPortMax)&&!s(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(k);p=a.axisY.convertValueToPixel(g[f].y[0]);l=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*h/2-(a.previousDataSeriesCount+n)*h<<0:b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+n)*h<<0,w=a.axisX.reversed?m-h<<0:m+h<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(p>l){var t=p;p=
l;l=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:f,x1:m,y1:p,x2:w,y2:l};Z(c,m,p,w,l,b,0,b,v,v,!1,!1,q.fillOpacity);b=R(t);u&&Z(this._eventManager.ghostCtx,m,p,w,l,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?l:p},direction:g[f].y[1]>=g[f].y[0]?
-1:1,bounds:{x1:m,y1:Math.min(p,l),x2:w,y2:Math.max(p,l)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?p:l},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(p,l),x2:w,y2:Math.max(p,l)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=!1,p=this.plotArea,l=0,k,h,n,r,q,g,v,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(p.x1,p.y1,p.width,p.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(p.x1,p.y1,p.width,p.height),this._eventManager.ghostCtx.clip());for(var w=0,t=0;t<this.data.length;t++)!this.data[t].type.match(/(bar|column)/ig)||
!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&w||w++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var z=a.dataSeriesIndexes[x],F=this.data[z],B=F.dataPoints,C=s(F._linkedSeries)?!1:F._linkedSeries.type.match(/(bar|column)/ig)&&F._linkedSeries.visible?!0:!1,D=0;if(C)for(e=F._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&D||(this.data[t].type.match(/(range)/ig)&&(f=!0),D++);e=this.options.dataPointMinWidth?
this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?w:1)))<<0:0.3*this.width;f&&(l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?w:1)))<<0:0.03*this.width);t=this.options.dataPointWidth?this.dataPointWidth:
0.9*((b?p.height:p.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(C?w:1))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>l&&(t=l);if(0<B.length)for(var E=F._colorSet,l=0;l<B.length;l++){var e=F.lineColor=F.options.color?F.options.color:E[0],T={color:B[l].whiskerColor?
B[l].whiskerColor:B[l].color?F.whiskerColor?F.whiskerColor:B[l].color:F.whiskerColor?F.whiskerColor:e,thickness:s(B[l].whiskerThickness)?F.whiskerThickness:B[l].whiskerThickness,dashType:B[l].whiskerDashType?B[l].whiskerDashType:F.whiskerDashType,length:s(B[l].whiskerLength)?s(F.options.whiskerLength)?t:F.options.whiskerLength:B[l].whiskerLength,trimLength:s(B[l].whiskerLength)?s(F.options.whiskerLength)?50:0:0};T.length="number"===typeof T.length?0>=T.length?0:T.length>=t?t:T.length:"string"===typeof T.length?
parseInt(T.length)*t/100>t?t:parseInt(T.length)*t/100>t:t;T.thickness="number"===typeof T.thickness?0>T.thickness?0:Math.round(T.thickness):2;var S={color:B[l].stemColor?B[l].stemColor:B[l].color?F.stemColor?F.stemColor:B[l].color:F.stemColor?F.stemColor:e,thickness:B[l].stemThickness?B[l].stemThickness:F.stemThickness,dashType:B[l].stemDashType?B[l].stemDashType:F.stemDashType};S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;B[l].getTime?v=B[l].x.getTime():v=B[l].x;
if(!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax)&&!s(B[l].y)&&B[l].y.length&&"number"===typeof B[l].y[0]&&"number"===typeof B[l].y[1]){var ia=a.axisX.convertValueToPixel(v);b?h=ia:k=ia;ia=a.axisY.convertValueToPixel(B[l].y[0]);b?n=ia:q=ia;ia=a.axisY.convertValueToPixel(B[l].y[1]);b?r=ia:g=ia;b?(q=a.axisX.reversed?h+(C?w:1)*t/2-(C?D-1:0)*t<<0:h-(C?w:1)*t/2+(C?D-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?k+(C?w:1)*t/2-(C?D-1:0)*t<<0:k-(C?w:1)*t/2+(C?D-1:0)*t<<
0,r=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ia=q,q=g,g=ia);b&&n>r&&(ia=n,n=r,r=ia);ia=F.dataPointIds[l];this._eventManager.objectMap[ia]={id:ia,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:l,x1:Math.min(n,r),y1:Math.min(q,g),x2:Math.max(r,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:S,whiskerProperties:T};y(c,Math.min(n,r),Math.min(q,g),Math.max(r,n),Math.max(g,q),e,T,S,b);u&&y(this._eventManager.ghostCtx,n,q,r,g,e,T,S,b);if(B[l].indexLabel||F.indexLabel||B[l].indexLabelFormatter||
F.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:B[l],dataSeries:F,indexKeyword:0,point:{x:b?B[l].y[1]>=B[l].y[0]?n:r:n+(r-n)/2,y:b?q+(g-q)/2:B[l].y[1]>=B[l].y[0]?g:q},direction:B[l].y[1]>=B[l].y[0]?-1:1,bounds:{x1:b?Math.min(n,r):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,r):r,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:B[l],dataSeries:F,indexKeyword:1,point:{x:b?B[l].y[1]>=B[l].y[0]?r:n:n+(r-n)/2,y:b?q+(g-q)/2:B[l].y[1]>=
B[l].y[0]?q:g},direction:B[l].y[1]>=B[l].y[0]?1:-1,bounds:{x1:b?Math.min(n,r):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,r):r,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(p.x1,p.y1,p.width,p.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,p,l,k,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
this.dataPointWidth:1;p=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0;var n=a.axisX.dataInfo.minDiff;isFinite(n)||(n=0.3*Math.abs(a.axisX.range));n=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):Math.abs(n)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>
p&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<f)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>p&&(n=p);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var q=
a.dataSeriesIndexes[r],g=this.data[q],v=g.dataPoints;if(0<v.length){var m=5<n&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<v.length;f++)if(v[f].getTime?h=v[f].x.getTime():h=v[f].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!s(v[f].y)&&v[f].y.length&&"number"===typeof v[f].y[0]&&"number"===typeof v[f].y[1]){p=a.axisY.convertValueToPixel(v[f].y[0]);l=a.axisY.convertValueToPixel(v[f].y[1]);k=a.axisX.convertValueToPixel(h);k=a.axisX.reversed?k+a.plotType.totalDataSeries*
n/2-(a.previousDataSeriesCount+r)*n<<0:k-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+r)*n<<0;var w=a.axisX.reversed?k-n<<0:k+n<<0;p>l&&(b=p,p=l,l=b);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];Z(c,p,k,l,w,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:p,y1:k,x2:l,y2:w};b=R(b);u&&Z(this._eventManager.ghostCtx,p,k,l,w,b,0,null,!1,!1,!1,!1);if(v[f].indexLabel||g.indexLabel||
v[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:v[f],dataSeries:g,indexKeyword:0,point:{x:v[f].y[1]>=v[f].y[0]?p:l,y:k+(w-k)/2},direction:v[f].y[1]>=v[f].y[0]?-1:1,bounds:{x1:Math.min(p,l),y1:k,x2:Math.max(p,l),y2:w},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:v[f],dataSeries:g,indexKeyword:1,point:{x:v[f].y[1]>=v[f].y[0]?l:p,y:k+(w-k)/2},direction:v[f].y[1]>=v[f].y[0]?1:-1,bounds:{x1:Math.min(p,l),y1:k,x2:Math.max(p,l),y2:w},
color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,
animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(x){var a=null;0<n.lineThickness&&b.stroke();for(var c=k.length-1;0<=c;c--)a=k[c],b.lineTo(a.x,a.y),e.lineTo(a.x,a.y);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y);for(c=0;c<k.length;c++)a=k[c],b.lineTo(a.x,a.y);b.stroke()}b.beginPath();b.moveTo(m,s);e.beginPath();e.moveTo(m,
s);x={x:m,y:s};k=[];k.push({x:m,y:w})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],p=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(p.x1,p.y1,p.width,p.height);b.clip();u&&(e.beginPath(),e.rect(p.x1,p.y1,p.width,p.height),e.clip());for(var l=0;l<a.dataSeriesIndexes.length;l++){var k=[],h=a.dataSeriesIndexes[l],n=this.data[h],r=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",
dataSeriesIndex:h};f=R(f);e.fillStyle=f;var f=[],q=!0,g=0,m,s,w,t,x=null;if(0<r.length){var z=n._colorSet[g%n._colorSet.length],F=n.lineColor=n.options.lineColor||z,B=F;b.fillStyle=z;b.strokeStyle=F;b.lineWidth=n.lineThickness;var C="solid";if(b.setLineDash){var y=N(n.nullDataLineDashType,n.lineThickness),C=n.lineDashType,D=N(C,n.lineThickness);b.setLineDash(D)}for(var T=!0;g<r.length;g++)if(t=r[g].x.getTime?r[g].x.getTime():r[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&
(!n.connectNullData||!T)))if(null!==r[g].y&&r[g].y.length&&"number"===typeof r[g].y[0]&&"number"===typeof r[g].y[1]){m=a.axisX.convertValueToPixel(t);s=a.axisY.convertValueToPixel(r[g].y[0]);w=a.axisY.convertValueToPixel(r[g].y[1]);q||T?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||C===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(k[k.length-1].newLineDashArray=D,C=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(m,s),u&&e.lineTo(m,s),k.push({x:m,y:w})):(b.beginPath(),
b.moveTo(m,s),x={x:m,y:s},k=[],k.push({x:m,y:w}),u&&(e.beginPath(),e.moveTo(m,s))),T=q=!1):(b.lineTo(m,s),k.push({x:m,y:w}),u&&e.lineTo(m,s),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:g,x1:m,y1:s,y2:w};g<r.length-1&&(B!==(r[g].lineColor||F)||C!==(r[g].lineDashType||n.lineDashType))&&(d(),B=r[g].lineColor||F,k[k.length-1].newStrokeStyle=B,b.strokeStyle=B,b.setLineDash&&(r[g].lineDashType?(C=r[g].lineDashType,k[k.length-
1].newLineDashArray=N(C,n.lineThickness),b.setLineDash(k[k.length-1].newLineDashArray)):(C=n.lineDashType,k[k.length-1].newLineDashArray=D,b.setLineDash(D))));if(0!==r[g].markerSize&&(0<r[g].markerSize||0<n.markerSize)){var S=n.getMarkerProperties(g,m,w,b);f.push(S);var E=R(t);u&&f.push({x:m,y:w,ctx:e,type:S.type,size:S.size,color:E,borderColor:E,borderThickness:S.borderThickness});S=n.getMarkerProperties(g,m,s,b);f.push(S);E=R(t);u&&f.push({x:m,y:s,ctx:e,type:S.type,size:S.size,color:E,borderColor:E,
borderThickness:S.borderThickness})}if(r[g].indexLabel||n.indexLabel||r[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:r[g],dataSeries:n,indexKeyword:0,point:{x:m,y:s},direction:r[g].y[0]>r[g].y[1]===a.axisY.reversed?-1:1,color:z}),this._indexLabels.push({chartType:"rangeArea",dataPoint:r[g],dataSeries:n,indexKeyword:1,point:{x:m,y:w},direction:r[g].y[0]>r[g].y[1]===a.axisY.reversed?1:-1,color:z})}else T||q||d(),T=!0;d();V.drawMarkers(f)}}u&&
(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(p.x1,p.y1,p.width,p.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,
easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderRangeSplineArea=function(a){function d(a,c){var d=w(s,2);if(0<d.length){if(0<h.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var f=0;f<d.length-3;f+=3){if(d[f].newStrokeStyle||d[f].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),d[f].newStrokeStyle&&(b.strokeStyle=d[f].newStrokeStyle),d[f].newLineDashArray&&b.setLineDash(d[f].newLineDashArray);b.bezierCurveTo(d[f+
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath();b.moveTo(d[0].x,d[0].y);u&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),u&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=w(ja,2);b.lineTo(ja[ja.length-1].x,ja[ja.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),u&&e.bezierCurveTo(d[f-1].x,d[f-1].y,
d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=h.fillOpacity;b.fill();u&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<h.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(s[g].newStrokeStyle||s[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),s[g].newStrokeStyle&&(b.strokeStyle=s[g].newStrokeStyle),s[g].newLineDashArray&&b.setLineDash(s[g].newLineDashArray);b.bezierCurveTo(d[f+
...
{objectType:"dataSeries",dataSeriesIndex:k};f=R(f);e.fillStyle=f;var f=[],r=0,q,g,m,s=[],ja=[];if(0<n.length){var t=h._colorSet[r%h._colorSet.length],x=h.lineColor=h.options.lineColor||t,z=x;b.fillStyle=t;b.lineWidth=h.lineThickness;var F="solid",B;if(b.setLineDash){var C=N(h.nullDataLineDashType,h.lineThickness),F=h.lineDashType;B=N(F,h.lineThickness)}for(g=!1;r<n.length;r++)if(q=n[r].x.getTime?n[r].x.getTime():n[r].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||
!g)))if(null!==n[r].y&&n[r].y.length&&"number"===typeof n[r].y[0]&&"number"===typeof n[r].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[r].y[0]);m=a.axisY.convertValueToPixel(n[r].y[1]);var y=h.dataPointIds[r];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:r,x1:q,y1:g,y2:m};s[s.length]={x:q,y:g};ja[ja.length]={x:q,y:m};r<n.length-1&&(z!==(n[r].lineColor||x)||F!==(n[r].lineDashType||h.lineDashType))&&(z=n[r].lineColor||x,s[s.length-
1].newStrokeStyle=z,b.setLineDash&&(n[r].lineDashType?(F=n[r].lineDashType,s[s.length-1].newLineDashArray=N(F,h.lineThickness)):(F=h.lineDashType,s[s.length-1].newLineDashArray=B)));if(0!==n[r].markerSize&&(0<n[r].markerSize||0<h.markerSize)){var D=h.getMarkerProperties(r,q,g,b);f.push(D);var T=R(y);u&&f.push({x:q,y:g,ctx:e,type:D.type,size:D.size,color:T,borderColor:T,borderThickness:D.borderThickness});D=h.getMarkerProperties(r,q,m,b);f.push(D);T=R(y);u&&f.push({x:q,y:m,ctx:e,type:D.type,size:D.size,
color:T,borderColor:T,borderThickness:D.borderThickness})}if(n[r].indexLabel||h.indexLabel||n[r].indexLabelFormatter||h.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[r],dataSeries:h,indexKeyword:0,point:{x:q,y:g},direction:n[r].y[0]<=n[r].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[r],dataSeries:h,indexKeyword:1,point:{x:q,y:m},direction:n[r].y[0]<=n[r].y[1]?1:-1,color:t});g=!1}else 0<r&&!g&&(h.connectNullData?b.setLineDash&&
(0<s.length&&(h.options.nullDataLineDashType||!n[r-1].lineDashType))&&(s[s.length-1].newLineDashArray=C,F=h.nullDataLineDashType):(d(B,x),s=[],ja=[])),g=!0;d(B,x);V.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(p.x1,p.y1,p.width,p.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,p=0,l,k,h,n,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&p>k&&(p=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,k));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&k<p)&&(k=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,p));q<p&&(q=p);q>k&&(q=k);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,
f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var m=a.dataSeriesIndexes[g],s=this.data[m],w=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var t="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,x=1===Math.round(t)%2?-0.5:0;if(0<w.length)for(var z=5<q&&s.bevelEnabled?!0:!1,F=!1,B=null,C=null,p=0;p<w.length;p++)if(w[p].getTime?
n=w[p].x.getTime():n=w[p].x,"number"!==typeof w[p].y){if(0<p&&!F&&s.connectNullData)var y=s.options.nullDataLineDashType||!w[p-1].lineDashType?s.nullDataLineDashType:w[p-1].lineDashType;F=!0}else{l=a.axisX.convertValueToPixel(n);k=0===s.dataPointEOs[p].cumulativeSum?r:a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSum);h=0===s.dataPointEOs[p].cumulativeSumYStartValue?r:a.axisY.convertValueToPixel(s.dataPointEOs[p].cumulativeSumYStartValue);l=a.axisX.reversed?l+a.plotType.totalDataSeries*
q/2-(a.previousDataSeriesCount+g)*q<<0:l-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var D=a.axisX.reversed?l-q<<0:l+q<<0;k>h&&(e=k,k=h,h=e);a.axisY.reversed&&(e=k,k=h,h=e);e=s.dataPointIds[p];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:l,y1:k,x2:D,y2:h};var T=w[p].color?w[p].color:0<w[p].y?s.risingColor:s.fallingColor;Z(c,l,k,D,h,T,0,T,z,z,!1,!1,s.fillOpacity);e=R(e);u&&Z(this._eventManager.ghostCtx,l,k,D,h,e,0,null,!1,
!1,!1,!1);var S,T=l;S="undefined"!==typeof w[p].isIntermediateSum&&!0===w[p].isIntermediateSum||"undefined"!==typeof w[p].isCumulativeSum&&!0===w[p].isCumulativeSum?0<w[p].y?k:h:0<w[p].y?h:k;0<p&&B&&(!F||s.connectNullData)&&(F&&c.setLineDash&&c.setLineDash(N(y,t)),c.beginPath(),c.moveTo(B,C-x),c.lineTo(T,S-x),0<t&&c.stroke(),u&&(b.beginPath(),b.moveTo(B,C-x),b.lineTo(T,S-x),0<t&&b.stroke()));F=!1;B=D;C=0<w[p].y?k:h;T=w[p].lineDashType?w[p].lineDashType:s.options.lineDashType?s.options.lineDashType:
"shortDash";c.strokeStyle=w[p].lineColor?w[p].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(T=N(T,t),c.setLineDash(T));(w[p].indexLabel||s.indexLabel||w[p].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:w[p],dataSeries:s,point:{x:l+(D-l)/2,y:0<=w[p].y?k:h},direction:0>w[p].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(k,h),x2:D,y2:Math.max(k,h)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,
...
animationBase:0}}};var fa=function(a,d,c,b,e,f,p,l,k){if(!(0>c)){"undefined"===typeof l&&(l=1);if(!u){var h=Number((p%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===h&&(p-=1E-4)}a.save();a.globalAlpha=l;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,p,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,p,!1),0<=k&&a.arc(d.x,d.y,k*c,p,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
...
f.indexLabel?k.replaceKeywordsWithValue(f.indexLabel,f,h,e):h.indexLabelFormatter?h.indexLabelFormatter(m):h.indexLabel?k.replaceKeywordsWithValue(h.indexLabel,f,h,e):f.label?f.label:"";k._eventManager.objectMap[p]=l;l.center={x:z.x,y:z.y};l.y=f.y;l.radius=C;l.percentInnerRadius=D;l.indexLabelText=r;l.indexLabelPlacement=h.indexLabelPlacement;l.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:h.options.indexLabelLineColor?h.options.indexLabelLineColor:f.color?f.color:h._colorSet[e%
h._colorSet.length];l.indexLabelLineThickness=s(f.indexLabelLineThickness)?h.indexLabelLineThickness:f.indexLabelLineThickness;l.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:h.indexLabelLineDashType;l.indexLabelFontColor=f.indexLabelFontColor?f.indexLabelFontColor:h.indexLabelFontColor;l.indexLabelFontStyle=f.indexLabelFontStyle?f.indexLabelFontStyle:h.indexLabelFontStyle;l.indexLabelFontWeight=f.indexLabelFontWeight?f.indexLabelFontWeight:h.indexLabelFontWeight;l.indexLabelFontSize=
s(f.indexLabelFontSize)?h.indexLabelFontSize:f.indexLabelFontSize;l.indexLabelFontFamily=f.indexLabelFontFamily?f.indexLabelFontFamily:h.indexLabelFontFamily;l.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:h.options.indexLabelBackgroundColor?h.options.indexLabelBackgroundColor:h.indexLabelBackgroundColor;l.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:h.indexLabelMaxWidth?h.indexLabelMaxWidth:0.33*q.width;l.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?
f.indexLabelWrap:h.indexLabelWrap;l.startAngle=0===e?h.startAngle?h.startAngle/180*Math.PI:0:g[e-1].endAngle;l.startAngle=(l.startAngle+2*Math.PI)%(2*Math.PI);l.endAngle=l.startAngle+2*Math.PI/F*Math.abs(f.y);f=(l.endAngle+l.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);l.midAngle=f;if(l.midAngle>Math.PI/2-t&&l.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>l.midAngle)c=e;a++}else if(l.midAngle>3*Math.PI/2-t&&l.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>l.midAngle)d=e;b++}l.hemisphere=f>Math.PI/2&&
f<=3*Math.PI/2?"left":"right";l.indexLabelTextBlock=new ha(k.plotArea.ctx,{fontSize:l.indexLabelFontSize,fontFamily:l.indexLabelFontFamily,fontColor:l.indexLabelFontColor,fontStyle:l.indexLabelFontStyle,fontWeight:l.indexLabelFontWeight,horizontalAlign:"left",backgroundColor:l.indexLabelBackgroundColor,maxWidth:l.indexLabelMaxWidth,maxHeight:l.indexLabelWrap?5*l.indexLabelFontSize:1.5*l.indexLabelFontSize,text:l.indexLabelText,padding:0,textBaseline:"top"});l.indexLabelTextBlock.measureText()}p=f=
...
n.length;b++){var c=g[b].startAngle,d=g[b].endAngle;if(d>c){var e=0.07*C*Math.cos(g[b].midAngle),f=0.07*C*Math.sin(g[b].midAngle),l=!1;if(n[b].exploded){if(1E-9<Math.abs(g[b].center.x-(z.x+e))||1E-9<Math.abs(g[b].center.y-(z.y+f)))g[b].center.x=z.x+e*a,g[b].center.y=z.y+f*a,l=!0}else if(0<Math.abs(g[b].center.x-z.x)||0<Math.abs(g[b].center.y-z.y))g[b].center.x=z.x+e*(1-a),g[b].center.y=z.y+f*(1-a),l=!0;l&&(e={},e.dataSeries=h,e.dataPoint=h.dataPoints[b],e.index=b,k.toolTip.highlightObjects([e]));
...
k.indexLabelTextBlock.height/2),c-r<m&&(l=r,p=f(p,l,d+1),+p.toFixed(x)<+l.toFixed(x)&&(h=c>m?c-m:r-(l-p)))));h&&(d=k.indexLabelTextBlock.y+h,c=0,c="right"===k.hemisphere?z.x+Math.sqrt(Math.pow(u,2)-Math.pow(d-z.y,2)):z.x-Math.sqrt(Math.pow(u,2)-Math.pow(d-z.y,2)),k.midAngle>Math.PI/2-t&&k.midAngle<Math.PI/2+t?(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===k.hemisphere&&"right"===l.hemisphere&&c>l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x-15:"right"===k.hemisphere&&("left"===
a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):k.midAngle>3*Math.PI/2-t&&k.midAngle<3*Math.PI/2+t&&(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"right"===k.hemisphere&&"left"===l.hemisphere&&c<l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x+15:"left"===k.hemisphere&&("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-15)),k.indexLabelTextBlock.y=d,k.indexLabelTextBlock.x=c,k.indexLabelAngle=Math.atan2(k.indexLabelTextBlock.y-
...
p.midAngle;p.radius=C;p.percentInnerRadius=D}for(var s,t,a=0;a<n.length;a++){var p=g[a],B=e(a);if(null!==B){s=g[a];t=g[B];var F=0,F=b(s,t)-m;if(0>F){for(var E=t=0,H=0;H<n.length;H++)H!==a&&g[H].hemisphere===p.hemisphere&&(g[H].indexLabelTextBlock.y<p.indexLabelTextBlock.y?t++:E++);t=F/(t+E||1)*E;var E=-1*(F-t),J=H=0;"right"===p.hemisphere?(H=f(a,t),E=-1*(F-H),J=f(B,E),+J.toFixed(x)<+E.toFixed(x)&&+H.toFixed(x)<=+t.toFixed(x)&&f(a,-(E-J))):(H=f(B,t),E=-1*(F-H),J=f(a,E),+J.toFixed(x)<+E.toFixed(x)&&
+H.toFixed(x)<=+t.toFixed(x)&&f(B,-(E-J)))}}}}else for(a=0;a<n.length;a++)p=g[a],u="pie"===h.type?0.7*C:0.8*C,B=z.x+u*Math.cos(p.midAngle),t=z.y+u*Math.sin(p.midAngle),p.indexLabelTextBlock.x=B,p.indexLabelTextBlock.y=t;for(a=0;a<n.length;a++)if(p=g[a],B=p.indexLabelTextBlock.measureText(),0!==B.height&&0!==B.width)B=B=0,"right"===p.hemisphere?(B=q.x2-(p.indexLabelTextBlock.x+p.indexLabelTextBlock.width+r),B*=-1):B=q.x1-(p.indexLabelTextBlock.x-p.indexLabelTextBlock.width-r),0<B&&(!l&&p.indexLabelText&&
...
for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,h=0;h<n.length;h++)if(f=!1,s=g[h],s.indexLabelText){var p=e(h);if(null!==p){var l=g[p];F=0;F=b(s,l);var k;if(k=0>F){k=s.indexLabelTextBlock.x;var q=s.indexLabelTextBlock.y-s.indexLabelTextBlock.height/2,m=s.indexLabelTextBlock.y+s.indexLabelTextBlock.height/2,t=l.indexLabelTextBlock.y-l.indexLabelTextBlock.height/
2,v=l.indexLabelTextBlock.x+l.indexLabelTextBlock.width,A=l.indexLabelTextBlock.y+l.indexLabelTextBlock.height/2;k=s.indexLabelTextBlock.x+s.indexLabelTextBlock.width<l.indexLabelTextBlock.x-r||k>v+r||q>A+r||m<t-r?!1:!0}k?(0>a&&(a=h),p!==a&&(c=p,d+=-F),0===h%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(M(d,a,c),c=a=-1,d=0)}}0<d&&M(d,a,c)})()}}function l(){k.plotArea.layoutManager.reset();k.title&&(k.title.dockInsidePlotArea||"center"===k.title.horizontalAlign&&"center"===k.title.verticalAlign)&&
k.title.render();if(k.subtitles)for(var a=0;a<k.subtitles.length;a++){var b=k.subtitles[a];(b.dockInsidePlotArea||"center"===b.horizontalAlign&&"center"===b.verticalAlign)&&b.render()}k.legend&&(k.legend.dockInsidePlotArea||"center"===k.legend.horizontalAlign&&"center"===k.legend.verticalAlign)&&(k.legend.setLayout(),k.legend.render())}var k=this;if(!(0>=a.dataSeriesIndexes.length)){var h=this.data[a.dataSeriesIndexes[0]],n=h.dataPoints,r=10,q=this.plotArea,g=h.dataPointEOs,m=2,u,w=1.3,t=20/180*Math.PI,
x=6,z={x:(q.x2+q.x1)/2,y:(q.y2+q.y1)/2},F=0;a=!1;for(var B=0;B<n.length;B++)F+=Math.abs(n[B].y),!a&&("undefined"!==typeof n[B].indexLabel&&null!==n[B].indexLabel&&0<n[B].indexLabel.toString().length)&&(a=!0),!a&&("undefined"!==typeof n[B].label&&null!==n[B].label&&0<n[B].label.toString().length)&&(a=!0);if(0!==F){a=a||"undefined"!==typeof h.indexLabel&&null!==h.indexLabel&&0<h.indexLabel.toString().length;var C="inside"!==h.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,
q.height)/2;h.radius&&(C=Ra(h.radius,C));var y="undefined"!==typeof h.innerRadius&&null!==h.innerRadius?Ra(h.innerRadius,C):0.7*C;h.radius=C;"doughnut"===h.type&&(h.innerRadius=y);var D=Math.min(y/C,(C-1)/C);this.pieDoughnutClickHandler=function(a){k.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&k._animator.animate(0,500,function(a){c(a);l()}))};d();p();p();p();p();this.disableToolTip=!0;this._animator.animate(0,
this.animatedRender?this.animationDuration:0,function(a){var b=k.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=k.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);a=g[0].startAngle+2*Math.PI*a;for(b=0;b<n.length;b++){var c=0===b?g[b].startAngle:d,d=c+(g[b].endAngle-g[b].startAngle),e=!1;d>a&&(d=a,e=!0);var f=n[b].color?n[b].color:h._colorSet[b%h._colorSet.length];d>c&&fa(k.plotArea.ctx,g[b].center,g[b].radius,f,h.type,c,d,h.fillOpacity,g[b].percentInnerRadius);if(e)break}l()},
...
a.closePath(),a.fillStyle=b?b:d.color,a.fill(),a.globalAplha=1,a.restore())};m.prototype.renderFunnel=function(a){function d(){for(var a=0,b=[],c=0;c<x.length;c++){if("undefined"===typeof x[c].y)return-1;x[c].y="number"===typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*D/a);return b}function c(){var a=W,b=V,c=M,d=ba,e,f;e=L;f=O-Q;d=Math.abs((f-e)*(b-a+(d-c))/2);c=ba-M;e=f-e;f=c*(f-O);f=Math.abs(f);f=d+f;for(var d=[],g=0,h=0;h<x.length;h++){if("undefined"===
typeof x[h].y)return-1;x[h].y="number"===typeof x[h].y?x[h].y:0;g+=Math.abs(x[h].y)}if(0===g)return-1;for(var p=d[0]=0,l=0,k,n,b=b-a,p=!1,h=0;h<x.length;h++)a=Math.abs(x[h].y)*f/g,p?k=0==Number(c.toFixed(3))?0:a/c:(n=Y*Y*b*b-4*Math.abs(Y)*a,0>n?(n=c,p=(b+n)*(e-l)/2,a-=p,k=e-l,l+=e-l,k+=0==n?0:a/n,l+=a/n,p=!0):(k=(Math.abs(Y)*b-Math.sqrt(n))/2,n=b-2*k/Math.abs(Y),l+=k,l>e&&(l-=k,n=c,p=(b+n)*(e-l)/2,a-=p,k=e-l,l+=e-l,k+=a/n,l+=a/n,p=!0),b=n)),d.push(k);return d}function b(){if(t&&x){for(var a,b,c,d,
e,f,h,l,p,k,n,q,r,m,v=[],A=[],w={percent:null,total:null},B=null,z=0;z<x.length;z++)m=P[z],m="undefined"!==typeof m.x5?(m.y2+m.y4)/2:(m.y2+m.y3)/2,m=g(m).x2+1,v[z]=K-m-U;m=0.5*U;for(var z=0,C=x.length-1;z<x.length||0<=C;z++,C--){b=t.reversed?x[C]:x[z];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-z)%t._colorSet.length]:t._colorSet[z%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(u?"transparent":null);
e=b.indexLabelFontColor||t.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;h=b.indexLabelFontStyle||t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||"arial";p=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||t.options.indexLabelLineColor||a;k="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;
n=b.indexLabelLineDashType||t.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;r=t.dataPointIds[z];y._eventManager.objectMap[r]={id:r,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-z:z]};"inside"===t.indexLabelPlacement&&(v[z]=z!==aa?t.reversed?P[z].x2-P[z].x1:P[z].x3-P[z].x4:P[z].x3-P[z].x6,20>v[z]&&(v[z]=z!==aa?t.reversed?P[z].x3-P[z].x4:P[z].x2-P[z].x1:
P[z].x2-P[z].x1,v[z]/=2));r=b.indexLabelMaxWidth?b.indexLabelMaxWidth:t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:v[z];if(r>v[z]||0>r)r=v[z];A[z]="inside"===t.indexLabelPlacement?P[z].height:!1;w=y.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)B={chart:y.options,dataSeries:t,dataPoint:b,total:w.total,percent:w.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,t,z):t.indexLabelFormatter?t.indexLabelFormatter(B):
t.indexLabel?y.replaceKeywordsWithValue(t.indexLabel,b,t,z):b.label?b.label:"";0>=k&&(k=0);1E3>r&&1E3-r<m&&(r+=1E3-r);R.roundRect||Aa(R);c=new ha(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:h,fontWeight:p,horizontalAlign:c,backgroundColor:d,maxWidth:r,maxHeight:!1===A[z]?q?4.28571429*f:1.5*f:A[z],text:b,padding:ca});c.measureText();I.push({textBlock:c,id:t.reversed?C:z,isDirty:!1,lineColor:a,lineThickness:k,lineDashType:n,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?
c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,h=K-V-U/2,h=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>h?h:t.indexLabelMaxWidth:h,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||h;if(c>h||0>c)c=h;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=K-h,c=I[l].textBlock.height<
I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>la+F&&(I[l].textBlock.y=la+F-I[l].height),I[l].textBlock.y<qa-F&&(I[l].textBlock.y=qa-F)):(I[l].textBlock.y<la-F&&(I[l].textBlock.y=la-F),I[l].textBlock.y+I[l].height>qa+F&&(I[l].textBlock.y=
qa+F-I[l].height))}function f(){var a,b,c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=t.reversed?"undefined"!==typeof a.x5?c>ua?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<ua?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,t.reversed?(I[e].textBlock.y+I[e].height>la+F&&(I[e].textBlock.y=la+F-I[e].height),
I[e].textBlock.y<qa-F&&(I[e].textBlock.y=qa-F)):(I[e].textBlock.y<la-F&&(I[e].textBlock.y=la-F),I[e].textBlock.y+I[e].height>qa+F&&(I[e].textBlock.y=qa+F-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=aa?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=aa?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function p(){function a(b,c){var d;if(0>b||b>=I.length)return 0;
var e,f=I[b].textBlock;if(0>c){c*=-1;e=r(b);d=l(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=l(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,h;f=(O-L+2*F)/k;h=k;for(var l,p=1;p<h;p++){e=p*f;for(var n=I.length-1;0<=n;n--)!I[n].isDirty&&(I[n].textBlock.y<e&&I[n].textBlock.y+I[n].height>e)&&(l=q(n),!(l>=I.length-1)&&I[n].textBlock.y+I[n].height+ca>I[l].textBlock.y&&
...
(h&&e+d+ca>+p.y.toFixed(6))&&(d=g.y+d+ca-p.y,e=a(m,-d),e<d&&(0<e&&(d-=e),e=a(q(m),d),e!=d)));m--);b()}}function l(a,b){return(b<P.length?I[b].textBlock.y:t.reversed?la+F:qa+F)-(0>a?t.reversed?qa-F:la-F:I[a].textBlock.y+I[a].height+ca)}function k(a,b,c){var d,e,g,l=[],p=F,r=[];-1!==b&&(0<=X.indexOf(b)?(e=X.indexOf(b),X.splice(e,1)):(X.push(b),X=X.sort(function(a,b){return a-b})));if(0===X.length)l=ga;else{e=F*(1!=X.length||0!=X[0]&&X[0]!=P.length-1?2:1)/h();for(var q=0;q<P.length;q++){if(1==X.length&&
0==X[0]){if(0===q){l.push(ga[q]);d=p;continue}}else 0===q&&(d=-1*p);l.push(ga[q]+d);if(0<=X.indexOf(q)||q<P.length&&0<=X.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var s={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return J.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof r[d]&&(r[d]=0),0>r&&(r*=-1),c.y1+=b-r[d],c.y2+=b-r[d],c.y3+=
b-r[d],c.y4+=b-r[d],c.y5&&(c.y5+=b-r[d],c.y6+=b-r[d]),r[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;fa=!0;d.clearRect(z.x1,z.y1,z.x2-z.x1,z.y2-z.y1);d.fillStyle=a.backgroundColor;d.fillRect(z.x1,z.y1,z.width,z.height);s.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[x.length-1-b]:t.dataPoints[b];e.index=t.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)pa(d,P[e],t.fillOpacity);w(d);H&&("inside"!==t.indexLabelPlacement?
n(d):f(),m(d));1<=c&&(fa=!1)},null,J.easing.easeOutQuart)}function h(){for(var a=0,b=0;b<P.length-1;b++)(0<=X.indexOf(b)||0<=X.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(N(I[f].lineDashType,I[f].lineThickness)),
a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}function r(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=P.length&&a!=P.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<x.length;c++)if(P[c].y1<a&&P[c].y4>a){b=P[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function m(a){for(var b=0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=
a),I[b].textBlock.render(!0))}function w(a){y.plotArea.layoutManager.reset();a.roundRect||Aa(a);y.title&&(y.title.dockInsidePlotArea||"center"===y.title.horizontalAlign&&"center"===y.title.verticalAlign)&&(y.title.ctx=a,y.title.render());if(y.subtitles)for(var b=0;b<y.subtitles.length;b++){var c=y.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)y.subtitles.ctx=a,c.render()}y.legend&&(y.legend.dockInsidePlotArea||"center"===y.legend.horizontalAlign&&"center"===
y.legend.verticalAlign)&&(y.legend.ctx=a,y.legend.setLayout(),y.legend.render());Fa.fNg&&Fa.fNg(y)}var y=this;if(!(0>=a.dataSeriesIndexes.length)){for(var t=this.data[a.dataSeriesIndexes[0]],x=t.dataPoints,z=this.plotArea,F=0.025*z.width,B=0.01*z.width,C=0,D=z.height-2*F,E=Math.min(z.width-2*B,2.8*z.height),H=!1,S=0;S<x.length;S++)if(!H&&("undefined"!==typeof x[S].indexLabel&&null!==x[S].indexLabel&&0<x[S].indexLabel.toString().length)&&(H=!0),!H&&("undefined"!==typeof x[S].label&&null!==x[S].label&&
0<x[S].label.toString().length)&&(H=!0),!H&&"function"===typeof t.indexLabelFormatter||"function"===typeof x[S].indexLabelFormatter)H=!0;H=H||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&H||(B=(z.width-0.75*E)/2);var S=z.x1+B,K=z.x2-B,L=z.y1+F,O=z.y2-F,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==x.length){var Q,G;a=75*E/100;var U=30*(K-a)/100;"funnel"===t.type?(Q=s(t.options.neckHeight)?
0.35*D:t.neckHeight,G=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===typeof Q&&Q.match(/%$/)?(Q=parseInt(Q),Q=Q*D/100):Q=parseInt(Q),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),Q>D?Q=D:0>=Q&&(Q=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=Q=0,t.reversed=t.reversed?!1:!0);var B=S+a/2,W=S,V=S+a,la=t.reversed?O:L,M=B-G/2,ba=B+G/2,ua=t.reversed?L+Q:O-Q,qa=t.reversed?L:O;a=[];var B=[],P=[],E=[],Z=L,aa,Y=(ua-la)/(M-W),da=-Y,S="area"===(t.valueRepresents?t.valueRepresents:
"height")?c():d();if(-1!==S){if(t.reversed)for(E.push(Z),G=S.length-1;0<G;G--)Z+=S[G],E.push(Z);else for(G=0;G<S.length;G++)Z+=S[G],E.push(Z);if(t.reversed)for(G=0;G<S.length;G++)E[G]<ua?(a.push(M),B.push(ba),aa=G):(a.push((E[G]-la+Y*W)/Y),B.push((E[G]-la+da*V)/da));else for(G=0;G<S.length;G++)E[G]<ua?(a.push((E[G]-la+Y*W)/Y),B.push((E[G]-la+da*V)/da),aa=G):(a.push(M),B.push(ba));for(G=0;G<S.length-1;G++)Z=t.reversed?x[x.length-1-G].color?x[x.length-1-G].color:t._colorSet[(x.length-1-G)%t._colorSet.length]:
x[G].color?x[G].color:t._colorSet[G%t._colorSet.length],G===aa?P.push({x1:a[G],y1:E[G],x2:B[G],y2:E[G],x3:ba,y3:ua,x4:B[G+1],y4:E[G+1],x5:a[G+1],y5:E[G+1],x6:M,y6:ua,id:G,height:E[G+1]-E[G],color:Z}):P.push({x1:a[G],y1:E[G],x2:B[G],y2:E[G],x3:B[G+1],y3:E[G+1],x4:a[G+1],y4:E[G+1],id:G,height:E[G+1]-E[G],color:Z});var ca=2,I=[],fa=!1,X=[],ga=[],S=!1;a=a=0;Ba(X);for(G=0;G<x.length;G++)x[G].exploded&&(S=!0,t.reversed?X.push(x.length-1-G):X.push(G));R.clearRect(z.x1,z.y1,z.width,z.height);R.fillStyle=
y.backgroundColor;R.fillRect(z.x1,z.y1,z.width,z.height);if(H&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){p();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(K-a)/2,0==G&&(C=a),C>a&&(C=a));for(G=0;G<P.length;G++)P[G].x1+=C,P[G].x2+=C,P[G].x3+=C,P[G].x4+=C,P[G].x5&&(P[G].x5+=C,P[G].x6+=C),I[G].textBlock.x+=C}for(G=0;G<P.length;G++)C=P[G],pa(R,C,t.fillOpacity),ga.push(C.y1);w(R);H&&t.visible&&("inside"===t.indexLabelPlacement||y.animationEnabled||n(R),y.animationEnabled||
m());if(!H)for(G=0;G<x.length;G++)C=t.dataPointIds[G],a={id:C,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-G:G]},y._eventManager.objectMap[C]=a;!y.animationEnabled&&S?k(y,-1,0):y.animationEnabled&&!y.animatedRender&&k(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!fa&&!y.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||
"pyramid"===t.type)t.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;k(y,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){J.fadeInAnimation(a,b);1<=a&&(k(y,-1,500),w(y.plotArea.ctx||y.ctx))},easingFunction:J.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||
...
c.xValueFormatString="#,##0.########",f._cultureInfo);else return"y"===a?Y(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?Y(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};ma(E,H);E.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),
...
u=r.markerSize||"line"!==r.type&&"stepLine"!==r.type&&"spline"!==r.type?0.75*this.lineHeight:0,w=r.legendMarkerBorderColor?r.legendMarkerBorderColor:r.markerBorderColor,t=r.legendMarkerBorderThickness?r.legendMarkerBorderThickness:r.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0;"error"===r.type&&this.errorMarkerColor.push(m);g=this.chart.replaceKeywordsWithValue(g,r.dataPoints[0],r,n);q={markerType:q,markerColor:m,text:g,textBlock:null,chartType:r.type,markerSize:u,lineColor:r._colorSet[0],
dataSeriesIndex:r.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:t};k.push(q)}else for(var x=0;x<r.dataPoints.length;x++){var z=r.dataPoints[x],q=z.legendMarkerType?z.legendMarkerType:r.legendMarkerType?r.legendMarkerType:L.getDefaultLegendMarker(r.type),g=z.legendText?z.legendText:r.legendText?r.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:r,dataPoint:z}):z.name?z.name:"DataPoint: "+(x+1),m=z.legendMarkerColor?z.legendMarkerColor:
r.legendMarkerColor?r.legendMarkerColor:z.color?z.color:r.color?r.color:r._colorSet[x%r._colorSet.length],u=0.75*this.lineHeight,w=z.legendMarkerBorderColor?z.legendMarkerBorderColor:r.legendMarkerBorderColor?r.legendMarkerBorderColor:z.markerBorderColor?z.markerBorderColor:r.markerBorderColor,t=z.legendMarkerBorderThickness?z.legendMarkerBorderThickness:r.legendMarkerBorderThickness?r.legendMarkerBorderThickness:z.markerBorderThickness||r.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0,g=this.chart.replaceKeywordsWithValue(g,
z,r,x),q={markerType:q,markerColor:m,text:g,textBlock:null,chartType:r.type,markerSize:u,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:t};(z.showInLegend||r.showInLegend&&!1!==z.showInLegend)&&k.push(q)}}!0===this.reversed&&k.reverse();if(0<k.length){r=null;m=g=z=x=0;z=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
f;u=0===u?0.75*this.lineHeight:u;z-=u+l;for(n=0;n<k.length;n++){q=k[n];w=z;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=p||"undefined"===typeof p||0>=w||"undefined"===typeof w)){if("horizontal"===this.orientation){q.textBlock=new ha(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?p:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(u+l+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!r||r.width+Math.round(q.textBlock.width+u+l+(0===r.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)r={items:[],width:0},h.push(r),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=
new ha(this.ctx,{x:0,y:0,maxWidth:z,maxHeight:!0===this.itemWrap?p:1.5*this.fontSize,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(u+l+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<p-this.lineHeight?(r={items:[],
width:0},h.push(r)):(r=h[x],x=(x+1)%h.length),this.height+=q.textBlock.height;q.textBlock.x=r.width;q.textBlock.y=0;r.width+=Math.round(q.textBlock.width+u+l+(0===r.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));r.items.push(q);this.width=Math.max(r.width,this.width);m=q.textBlock.width+(u+l+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=m;this.height=
...
d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,b=d.y2-this.height);this.items=k;for(n=0;n<this.items.length;n++)q=k[n],q.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[q.id]={id:q.id,objectType:"legendItem",legendItemIndex:n,dataSeriesIndex:q.dataSeriesIndex,dataPointIndex:q.dataPointIndex};this.markerSize=u;this.rows=h;0<k.length&&a.layoutManager.registerSpace(c,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:e,y1:b,x2:e+
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),l=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=ga("markerSize",g,this)||4,u=c?20:s,m=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));m<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:m});q=
Math.abs(q.x1-a);q<=k?k=q:0<p?h++:n++;m<=s/2&&(l=!0);break;case "rangeArea":case "rangeSplineArea":s=ga("markerSize",g,this)||4;u=c?20:s;m=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));m<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:m});q=Math.abs(q.x1-a);q<=k?k=q:0<p?h++:n++;m<=s/2&&(l=!0);break;case "bubble":s=q.size;m=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));m<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
distance:m}),l=!0);break;case "pie":case "doughnut":s=q.center;u="doughnut"===this.type?q.percentInnerRadius*q.radius:0;m=Math.sqrt(Math.pow(s.x-a,2)+Math.pow(s.y-d,2));m<q.radius&&m>u&&(m=Math.atan2(d-s.y,a-s.x),0>m&&(m+=2*Math.PI),m=Number(((180*(m/Math.PI)%360+360)%360).toFixed(12)),s=Number(((180*(q.startAngle/Math.PI)%360+360)%360).toFixed(12)),u=Number(((180*(q.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===u&&1<q.endAngle&&(u=360),s>=u&&0!==g.y&&(u+=360,m<s&&(m+=360)),m>s&&m<u&&(b.push({dataPoint:g,
...
Math.log(this.logarithmBase):Math.abs(this.range))*U[this.intervalType+"Duration"]*this.interval,f="undefined"===typeof this.options.labelMaxWidth?0.5*this.chart.width>>0:this.options.labelMaxWidth,this.chart.panEnabled||(p="undefined"===typeof this.options.labelWrap||this.labelWrap?0.8*this.chart.height>>0:1.5*this.labelFontSize);else if("left"===this._position||"right"===this._position)l=this.logarithmic&&!this.equidistantInterval&&2<=this._labels.length?this.lineCoordinates.height*Math.log(Math.min(this._labels[this._labels.length-
...
q[g].titleMaxWidth||f.width,q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.height:1.5*q[g].titleFontSize,q[g]._titleTextBlock.angle=0}if("normal"===e){for(var x=[],z=[],y=[],B=[],L=[],N=[],O=[],Q=[];4>u;){var G=0,R=0,U=0,X=0,W=e=0,M=0,Z=0,V=0,Y=0,P=0,aa=0;if(c&&0<c.length)for(y=[],g=P=0;g<c.length;g++)y.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateWidth():0)),P+=y[g],M+=c[g]&&!n.isNavigator?c[g].margin:0;else y.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));O.push(y);if(b&&
0<b.length)for(B=[],g=aa=0;g<b.length;g++)B.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),aa+=B[g],Z+=b[g]?b[g].margin:0;else B.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));Q.push(B);p=Math.round(f.x1+P+M);k=Math.round(f.x2-aa-Z>n.width-r?n.width-r:f.x2-aa-Z);if(a&&0<a.length)for(x=[],g=V=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(k-p),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?
a[g].titleMaxWidth:a[g].lineCoordinates.width),x.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),V+=x[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else x.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));L.push(x);if(d&&0<d.length)for(z=[],g=Y=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(k-p),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),
z.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),Y+=z[g],W+=d[g]&&!n.isNavigator?d[g].margin:0;else z.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));N.push(z);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates.x1=p,k=Math.round(f.x2-aa-Z>n.width-r?n.width-r:f.x2-aa-Z),a[g]._labels&&1<a[g]._labels.length&&(l=h=0,h=a[g]._labels[1],l="dateTime"===a[g].valueType?a[g]._labels[a[g]._labels.length-2]:a[g]._labels[a[g]._labels.length-1],w=h.textBlock.width*Math.cos(Math.PI/
180*Math.abs(h.textBlock.angle))+(h.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),t=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(C)||s(D)||n.isNavigator||n.stockChart)||(l=0,0<a[g].labelAngle?D+t>k&&(l+=0<a[g].labelAngle?D+t-k-aa:0):0>a[g].labelAngle?C-w<p&&C-w<a[g].viewportMinimum&&(E=p-(M+a[g].tickLength+
y+C-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(D+t>k&&(l=D+t/2-k-aa),C-w<p&&C-w<a[g].viewportMinimum&&(E=p-M-a[g].tickLength-y-C+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&0<l?k-=l:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?p+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(p+=E),0<l&&(k-=l))),n.panEnabled?V=s(n.sessionVariables.axisX.height)?
n.sessionVariables.axisX.height=V:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=V,l=Math.round(f.y2-V-e+G),h=Math.round(f.y2),a[g].lineCoordinates.x2=k,a[g].lineCoordinates.width=k-p,a[g].lineCoordinates.y1=l,a[g].lineCoordinates.y2=l+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+x[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+
a[g].lineThickness/2),a[g].bounds={x1:p,y1:l,x2:k,y2:h-(V+e-x[g]-G),width:k-p,height:h-l}),G+=x[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+P+M),d[g].lineCoordinates.x2=Math.round(f.x2-aa-Z>n.width-r?n.width-r:f.x2-aa-Z),d[g].lineCoordinates.width=Math.abs(k-p),d[g]._labels&&1<d[g]._labels.length&&(h=d[g]._labels[1],l="dateTime"===d[g].valueType?d[g]._labels[d[g]._labels.length-2]:d[g]._labels[d[g]._labels.length-1],w=h.textBlock.width*Math.cos(Math.PI/
180*Math.abs(h.textBlock.angle))+(h.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),t=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle))),n.panEnabled?Y=s(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=Y:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=Y,l=Math.round(f.y1),h=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=
l+Y+W-R,d[g].lineCoordinates.y2=l,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-z[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:p,y1:l+(Y+W-z[g]-R),x2:k,y2:h,width:k-p,height:h-l},R+=z[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)M=n.isNavigator?0:10,c[g]&&(p=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:r,l=Math.round(f.y1+
Y+W<Math.max(M,r)?Math.max(M,r):f.y1+Y+W),k=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/2:r,h=Math.round(f.y2-V-e-M),c[g].lineCoordinates={x1:p-U,y1:l,x2:k-U,y2:h,height:Math.abs(h-l)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(y[g]-c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=
c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:p-(y[g]+U),y1:l,x2:k,y2:h,width:k-p,height:h-l},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),U+=y[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(p=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),k=Math.round(p),M=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/
2:0,l=Math.round(f.y1+Y+W<Math.max(M,r)?Math.max(M,r):f.y1+Y+W),M=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,h=Math.round(f.y2-(V+e+M)),b[g].lineCoordinates={x1:p+X,y1:l,x2:p+X,y2:h,height:Math.abs(h-l)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(B[g]-b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/
2),b[g].bounds={x1:p,y1:l,x2:k+(B[g]+X),y2:h,width:k-p,height:h-l},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:b[g].lineCoordinates.height),X+=B[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(C=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:
...
p),D=d[g].logarithmic?(1<p?Math.log(p)/d[g].conversionParameters.lnLogarithmBase*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1:(0<p?p*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)m=L[u-1][g]===L[u][g]?!0:!1;else m=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=N[u-
1][g]===N[u][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=O[u-1][g]===O[u][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=Q[u-1][g]===Q[u][g]?!0:!1;else K=!0}if(m&&H&&J&&K)break;u++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),
c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels()}else{r=[];C=[];E=[];w=[];D=[];t=[];L=[];for(N=[];4>u;){V=X=R=U=Z=M=W=e=Q=O=G=Y=0;if(a&&0<a.length)for(E=[],g=X=0;g<a.length;g++)E.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),X+=E[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));L.push(E);if(d&&0<d.length)for(w=[],g=V=0;g<d.length;g++)w.push(Math.ceil(d[g]?
d[g].createLabelsAndCalculateWidth():0)),V+=w[g],W+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():0));N.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},p=Math.round(f.x1+X+e),k=Math.round(f.x2-V-W>n.width-10?n.width-10:f.x2-V-W),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(p=0>c[g].labelAngle?Math.max(p,x):0===c[g].labelAngle?Math.max(p,x/2):p),0<!d.length&&(k=0<c[g].labelAngle?k-z/2:0===c[g].labelAngle?k-z/2:k)),c[g].lineCoordinates.x1=p,c[g].lineCoordinates.x2=
k,c[g].lineCoordinates.width=Math.abs(k-p),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},p=Math.round(f.x1+X+e),k=Math.round(f.x2-V-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-V-W),b[g]&&b[g].labelAutoFit&&!s(y)&&(0<!a.length&&(p=0<b[g].labelAngle?Math.max(p,y):0===b[g].labelAngle?Math.max(p,y/2):p),0<!d.length&&(k-=B/2)),
b[g].lineCoordinates.x1=p,b[g].lineCoordinates.x2=k,b[g].lineCoordinates.width=Math.abs(k-p),b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(r=[],g=U=0;g<c.length;g++)r.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),U+=r[g]+c[g].margin,M+=c[g].margin;else r.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));D.push(r);if(b&&0<b.length)for(C=[],
g=R=0;g<b.length;g++)C.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),R+=C[g],Z+=b[g].margin;else C.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():0));t.push(C);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(h=c[g]._labels[0],l=c[g]._labels[c[g]._labels.length-1],x=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),z=l.textBlock.width*Math.cos(Math.PI/
...
l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle)));if(n.panEnabled)for(g=0;g<c.length;g++)r[g]=s(n.sessionVariables.axisY.height)?n.sessionVariables.axisY.height=r[g]:n.sessionVariables.axisY.height;else for(g=0;g<c.length;g++)n.sessionVariables.axisY.height=r[g];if(c&&0<c.length)for(g=c.length-1;0<=g;g--)l=Math.round(f.y2),h=Math.round(f.y2>c[g].chart.height?c[g].chart.height:f.y2),c[g].lineCoordinates.y1=l-(r[g]+c[g].margin+Y),c[g].lineCoordinates.y2=l-(r[g]+c[g].margin+
Y),"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+r[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)-("inside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:p,y1:l-(r[g]+Y+c[g].margin),x2:k,y2:h-(Y+c[g].margin),width:k-p,height:r[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),
Y+=r[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(l=Math.round(f.y1),h=Math.round(f.y1+(C[g]+b[g].margin+G)),b[g].lineCoordinates.y1=h,b[g].lineCoordinates.y2=h,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=h-C[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)),b[g].bounds={x1:p,y1:l+(b[g].margin+G),x2:k,y2:h,width:k-p,height:R},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:
b[g].lineCoordinates.width),G+=C[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){M=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/2:0;p=Math.round(f.x1+e);l=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;k=Math.round(f.x1+X+e);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-U):f.y2>n.height-Math.max(M,10)?n.height-
Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(k=0>c[M].labelAngle?Math.max(k,x):0===c[M].labelAngle?Math.max(k,x/2):k,p=0>c[M].labelAngle||0===c[M].labelAngle?k-X:p);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(k=b[M].lineCoordinates.x1,p=k-X);a[g].lineCoordinates={x1:k-O,y1:l,x2:k-O,y2:h,height:Math.abs(h-l)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(E[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:
0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:k-(E[g]+O),y1:l,x2:k,y2:h,width:k-p,height:h-l};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();O+=E[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){M=d[g]._labels&&
0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;p=Math.round(f.x1-e);l=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;k=Math.round(f.x2-V-W);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-U):f.y2>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(k=0>c[M].labelAngle?
Math.max(k,x):0===c[M].labelAngle?Math.max(k,x/2):k,p=0>c[M].labelAngle||0===c[M].labelAngle?k-V:p);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(k=b[M].lineCoordinates.x2,p=k-V);d[g].lineCoordinates={x1:k+Q,y1:l,x2:k+Q,y2:h,height:Math.abs(h-l)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(w[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+
d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:l,x2:k+w[g]+Q,y2:h,width:k-p,height:h-l};d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();Q+=w[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<
u){if(a&&0<a.length)for(g=0;g<a.length;g++)m=L[u-1][g]===L[u][g]?!0:!1;else m=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=N[u-1][g]===N[u][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=D[u-1][g]===D[u][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=t[u-1][g]===t[u][g]?!0:!1;else K=!0}if(m&&H&&J&&K)break;u++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),
b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels()}};D.render=function(a,d,c,b,e){var f=a[0]?a[0].chart:d[0].chart;e=f.ctx;var k=f._axes;f.alignVerticalAxes&&f.alignVerticalAxes();e.save();e.beginPath();a[0]&&e.rect(5,a[0].bounds.y1,a[0].chart.width-10,a[0].bounds.height);d[0]&&e.rect(5,d[d.length-
...
if(b&&0<b.length)for(l=0;l<b.length;l++)b[l].renderStripLinesOfThicknessType("pixel")};D.prototype.calculateStripLinesThicknessInValues=function(){for(var a=0;a<this.stripLines.length;a++)if(null!==this.stripLines[a].startValue&&null!==this.stripLines[a].endValue){var d=Math.min(this.stripLines[a].startValue,this.stripLines[a].endValue),c=Math.max(this.stripLines[a].startValue,this.stripLines[a].endValue),d=this.getApparentDifference(d,c);this.stripLines[a].value=this.logarithmic?this.stripLines[a].value*
Math.sqrt(Math.log(this.stripLines[a].endValue/this.stripLines[a].startValue)/Math.log(d)):this.stripLines[a].value+(Math.abs(this.stripLines[a].endValue-this.stripLines[a].startValue)-d)/2;this.stripLines[a].thickness=d;this.stripLines[a]._thicknessType="value"}};D.prototype.calculateBreaksSizeInValues=function(){for(var a="left"===this._position||"right"===this._position?this.lineCoordinates.height||this.chart.height:this.lineCoordinates.width||this.chart.width,d=this.scaleBreaks?this.scaleBreaks._appliedBreaks:
[],c=this.conversionParameters.pixelPerUnit||a/(this.logarithmic?this.conversionParameters.maximum/this.conversionParameters.minimum:this.conversionParameters.maximum-this.conversionParameters.minimum),b=this.scaleBreaks&&!s(this.scaleBreaks.options.spacing),e,f=0;f<d.length;f++)e=b||!s(d[f].options.spacing),d[f].spacing=Ra(d[f].spacing,a,8,e?0.1*a:8,e?0:3)<<0,d[f].size=0>d[f].spacing?0:Math.abs(d[f].spacing/c),this.logarithmic&&(d[f].size=Math.pow(this.logarithmBase,d[f].size))};D.prototype.calculateBreaksInPixels=
...
this.scaleBreaks.lastBreakIndex=d),a[d].endValue<=this.conversionParameters.maximum&&(a[d].endPixel=this.convertValueToPixel(a[d].endValue)))}};D.prototype.renderLabelsTicksAndTitle=function(){var a=this,d=!1,c=0,b=0,e=1,f=0;0!==this.labelAngle&&360!==this.labelAngle&&(e=1.2);if("undefined"===typeof this.options.interval){if("bottom"===this._position||"top"===this._position)if(this.logarithmic&&!this.equidistantInterval&&this.labelAutoFit){for(var c=[],e=0!==this.labelAngle&&360!==this.labelAngle?
...
r.position<this.viewportMinimum||(r.position>this.viewportMaximum||d&&0!==f++%2&&this.labelAutoFit)||r.textBlock.render(!0)};D.prototype.renderInterlacedColors=function(){var a=this.chart.plotArea.ctx,d,c,b=this.chart.plotArea,e=0;d=!0;if(("bottom"===this._position||"top"===this._position)&&this.interlacedColor)for(a.fillStyle=this.interlacedColor,e=0;e<this._labels.length;e++)d?(d=this.getPixelCoordinatesOnAxis(this._labels[e].position),c=e+1>this._labels.length-1?this.getPixelCoordinatesOnAxis(this.viewportMaximum):
this.getPixelCoordinatesOnAxis(this._labels[e+1].position),a.fillRect(Math.min(c.x,d.x),b.y1,Math.abs(c.x-d.x),Math.abs(b.y1-b.y2)),d=!1):d=!0;else if(("left"===this._position||"right"===this._position)&&this.interlacedColor)for(a.fillStyle=this.interlacedColor,e=0;e<this._labels.length;e++)d?(c=this.getPixelCoordinatesOnAxis(this._labels[e].position),d=e+1>this._labels.length-1?this.getPixelCoordinatesOnAxis(this.viewportMaximum):this.getPixelCoordinatesOnAxis(this._labels[e+1].position),a.fillRect(b.x1,
Math.min(c.y,d.y),Math.abs(b.x1-b.x2),Math.abs(d.y-c.y)),d=!1):d=!0;a.beginPath()};D.prototype.renderStripLinesOfThicknessType=function(a){if(this.stripLines&&0<this.stripLines.length&&a){for(var d=this,c,b=0,e=0,f=!1,k=!1,l=[],m=[],k=!1,b=0;b<this.stripLines.length;b++){var h=this.stripLines[b];h._thicknessType===a&&("pixel"===a&&(h.value<this.viewportMinimum||h.value>this.viewportMaximum||s(h.value)||isNaN(this.range))||l.push(h))}for(b=0;b<this._stripLineLabels.length;b++)if(h=this.stripLines[b],
...
this.chart._breaksCanvasCtx.clip(),this.chart._breaksCanvasCtx.drawImage(this.maskCanvas,0,0,this.chart.width,this.chart.height),this.chart._breaksCanvasCtx.restore())};D.prototype.createMask=function(){if(this.scaleBreaks&&0<this.scaleBreaks._appliedBreaks.length){var a=this.scaleBreaks._appliedBreaks;u?(this.maskCanvas=ra(this.chart.width,this.chart.height),this.maskCtx=this.maskCanvas.getContext("2d")):(this.maskCanvas=this.chart.plotArea.canvas,this.maskCtx=this.chart.plotArea.ctx);this.maskCtx.save();
this.maskCtx.beginPath();this.maskCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.maskCtx.clip();for(var d=0;d<a.length;d++)a[d].endValue<this.viewportMinimum||(a[d].startValue>this.viewportMaximum||isNaN(this.range))||a[d].render(this.maskCtx);this.maskCtx.restore()}};D.prototype.renderCrosshair=function(a,d){isFinite(this.minimum)&&isFinite(this.maximum)&&(this.crosshair.render(a,d),this.crosshair.dispatchEvent("updated",{chart:this.chart,
crosshair:this.options,axis:this,value:this.crosshair.value},this))};D.prototype.showCrosshair=function(a){s(a)||(a<this.viewportMinimum||a>this.viewportMaximum)||("top"===this._position||"bottom"===this._position?this.crosshair.render(this.convertValueToPixel(a),null,a):this.crosshair.render(null,this.convertValueToPixel(a),a))};D.prototype.renderGrid=function(){if(this.gridThickness&&0<this.gridThickness){var a=this.chart.ctx;a.save();var d,c=this.chart.plotArea;a.lineWidth=this.gridThickness;a.strokeStyle=
...
0.5<<0:this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5};D.prototype.getApparentDifference=function(a,d,c,b){var e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];if(this.logarithmic){c=s(c)?d/a:c;for(var f=0;f<e.length&&!(d<e[f].startValue);f++)a>e[f].endValue||(a<=e[f].startValue&&d>=e[f].endValue?c=c/e[f].endValue*e[f].startValue*e[f].size:a>=e[f].startValue&&d>=e[f].endValue?c=c/e[f].endValue*a*Math.pow(e[f].size,Math.log(e[f].endValue/
...
this.intervalType="millisecond"):b/100<=a?(this.interval=100,this.intervalType="millisecond"):b/200<=a?(this.interval=200,this.intervalType="millisecond"):b/250<=a?(this.interval=250,this.intervalType="millisecond"):b/300<=a?(this.interval=300,this.intervalType="millisecond"):b/400<=a?(this.interval=400,this.intervalType="millisecond"):b/500<=a?(this.interval=500,this.intervalType="millisecond"):b/(1*U.secondDuration)<=a?(this.interval=1,this.intervalType="second"):b/(2*U.secondDuration)<=a?(this.interval=
2,this.intervalType="second"):b/(5*U.secondDuration)<=a?(this.interval=5,this.intervalType="second"):b/(10*U.secondDuration)<=a?(this.interval=10,this.intervalType="second"):b/(15*U.secondDuration)<=a?(this.interval=15,this.intervalType="second"):b/(20*U.secondDuration)<=a?(this.interval=20,this.intervalType="second"):b/(30*U.secondDuration)<=a?(this.interval=30,this.intervalType="second"):b/(1*U.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):b/(2*U.minuteDuration)<=a?(this.interval=
2,this.intervalType="minute"):b/(5*U.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):b/(10*U.minuteDuration)<=a?(this.interval=10,this.intervalType="minute"):b/(15*U.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):b/(20*U.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):b/(30*U.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):b/(1*U.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):b/(2*U.hourDuration)<=a?(this.interval=2,
this.intervalType="hour"):b/(3*U.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):b/(6*U.hourDuration)<=a?(this.interval=6,this.intervalType="hour"):b/(1*U.dayDuration)<=a?(this.interval=1,this.intervalType="day"):b/(2*U.dayDuration)<=a?(this.interval=2,this.intervalType="day"):b/(4*U.dayDuration)<=a?(this.interval=4,this.intervalType="day"):b/(1*U.weekDuration)<=a?(this.interval=1,this.intervalType="week"):b/(2*U.weekDuration)<=a?(this.interval=2,this.intervalType="week"):b/(3*U.weekDuration)<=
a?(this.interval=3,this.intervalType="week"):b/(1*U.monthDuration)<=a?(this.interval=1,this.intervalType="month"):b/(2*U.monthDuration)<=a?(this.interval=2,this.intervalType="month"):b/(3*U.monthDuration)<=a?(this.interval=3,this.intervalType="month"):b/(6*U.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*U.yearDuration)<=a?1:b/(2*U.yearDuration)<=a?2:b/(4*U.yearDuration)<=a?4:Math.floor(D.getNiceNumber(b/(a-1),!0)/U.yearDuration),this.intervalType="year"));if(null===
...
D.getNiceNumber((this.viewportMaximum-this.viewportMinimum)/(a-1),!0)))}if(null===this.minimum||null===this.maximum)if("axisX"===this.type?(e=null!==this.minimum?this.minimum:this.dataInfo.min,f=null!==this.maximum?this.maximum:this.dataInfo.max,0===f-e&&(b="undefined"===typeof this.options.interval?0.4:this.options.interval,f+=b,e-=b),k=Infinity!==this.dataInfo.minDiff?this.dataInfo.minDiff:1<f-e?0.5*Math.abs(f-e):1):"axisY"===this.type&&(e=null!==this.minimum?this.minimum:this.dataInfo.min,f=null!==
...
b?5:10:Math.max(Math.floor(b),1);return-20>c?Number(b*Math.pow(10,c)):Number((b*Math.pow(10,c)).toFixed(20))};D.getNiceNumber=function(a,d){var c=Math.floor(Math.log(a)/Math.LN10),b=a/Math.pow(10,c),b=d?1.5>b?1:3>b?2:7>b?5:10:1>=b?1:2>=b?2:5>=b?5:10;return-20>c?Number(b*Math.pow(10,c)):Number((b*Math.pow(10,c)).toFixed(20))};D.prototype.getLabelStartPoint=function(){var a=U[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===
...
this.parent.createUserOptions();this.options._isPlaceholder||(Ba(this.parent[this.optionsName]),d=this.parent.options[this.optionsName].indexOf(this.options));this.options="undefined"===typeof a?{}:a;this.parent.options[this.optionsName][d]=this.options}};ba.prototype.render=function(a){if(0!==this.spacing||0!==this.options.lineThickness&&("undefined"!==typeof this.options.lineThickness||0!==this.parent.lineThickness)){var d=this.ctx,c=this.ctx.globalAlpha;this.ctx=a||this.ctx;this.ctx.save();this.ctx.beginPath();
this.ctx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.ctx.clip();var b=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue),e=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue);this.ctx.strokeStyle=this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;R(this.id);var f,k,l,m,h,n;a=Math.max(this.spacing,3);var r=Math.max(0,this.lineThickness);this.ctx.lineWidth=r;this.ctx.setLineDash&&
...
0.3*this.chart.width:this.labelMaxWidth;this.labelMaxHeight=s(this.options.labelWrap)||this.labelWrap?0.3*this.chart.height:2*this.labelFontSize;0<r&&q.setLineDash&&q.setLineDash(N(this.lineDashType,r));h=new ha(q,{x:0,y:0,padding:{top:2,right:3,bottom:2,left:4},backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,maxWidth:this.labelMaxWidth,maxHeight:this.labelMaxHeight,angle:this.labelAngle,text:n,
...
this.parent.convertPixelToValue({y:d});for(var w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=u.index&&(u.dataSeries=this.parent.dataSeries[w],null!==u.dataPoint.y&&n.push(u));u=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));w=0;if("rangeBar"===n[0].dataSeries.type||"error"===n[0].dataSeries.type)for(var u=Math.abs(a-this.parent.convertValueToPixel(n[w].dataPoint.y[0])),
...
this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):s(this.options.label)?Y(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));z=t=0;for(v=w;0<=v;v--)z+=n[v].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(z)),t<u&&(u=t,b=v);l=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<
0)+0.5:this.parent.convertValueToPixel(z)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?Y(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=z=t=0;for(v=w;0<=v;v--)z+=n[v].dataPoint.y,y=n[v].dataPoint.x.getTime?n[v].dataPoint.x.getTime():
n[v].dataPoint.x,y=100*(z/n[v].dataSeries.plotUnit.dataPointYSums[y]),t=Math.abs(a-this.parent.convertValueToPixel(y)),t<u&&(u=t,b=v);l=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y}):s(this.options.label)?Y(c?c:y,this.valueFormatString,this.chart._cultureInfo):this.label}else l=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<
0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?Y(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=l;f=this.chart.plotArea.y1;k=this.chart.plotArea.y2;this.bounds={x1:b-r/2,y1:f,x2:e+r/2,y2:k};h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2?h.x=this.chart.bounds.x2-h.width:h.x<this.chart.bounds.x1&&
...
this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?Y(c?c:x.dataPoint.x,this.valueFormatString,
...
this.parent.convertPixelToValue({x:a});for(w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=u.index&&(u.dataSeries=this.parent.dataSeries[w],null!==u.dataPoint.y&&n.push(u));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});x=n[0];b=e=l=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;k=this.chart.plotArea.y2;this.bounds={x1:b-
r/2,y1:f,x2:e+r/2,y2:k};y=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=n)if(this.parent.labels[v])y=!0;else{y=!1;break}if(y){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({x:a}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=u.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):
s(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?
Y(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width);h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!s(this.parent.dataSeries)&&
0<this.parent.dataSeries.length&&(v=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));for(w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=u.index&&(u.dataSeries=this.parent.dataSeries[w],null!==u.dataPoint.y&&n.push(u));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});w=0;if("rangeColumn"===n[0].dataSeries.type||"rangeArea"===n[0].dataSeries.type||"error"===n[0].dataSeries.type||"rangeSplineArea"===n[0].dataSeries.type||
"candlestick"===n[0].dataSeries.type||"ohlc"===n[0].dataSeries.type||"boxAndWhisker"===n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y[0])),v=t=0;v<n.length;v++)if(n[v].dataPoint.y&&n[v].dataPoint.y.length)for(x=0;x<n[v].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[v].dataPoint.y[x])),t<u&&(u=t,w=v);else t=Math.abs(d-this.parent.convertValueToPixel(n[v].dataPoint.y)),t<u&&(u=t,w=v);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===
n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),v=z=t=0;v<n.length;v++)if(n[v].dataPoint.y&&n[v].dataPoint.y.length)for(x=0;x<n[v].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[v].dataPoint.y[x])),t<u&&(u=t,w=v);else z+=n[v].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(z)),t<u&&(u=t,w=v);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),
...
s(this.options.label)?Y(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=t=0;for(v=w;0<=v;v--)z+=n[v].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(z)),t<u&&(u=t,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<
0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?Y(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=t=0;for(v=w;0<=v;v--)z+=n[v].dataPoint.y,y=n[v].dataPoint.x.getTime?
n[v].dataPoint.x.getTime():n[v].dataPoint.x,y=100*(z/n[v].dataSeries.plotUnit.dataPointYSums[y]),t=Math.abs(d-this.parent.convertValueToPixel(y)),t<u&&(u=t,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y}):s(this.options.label)?Y(c?c:y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else"waterfall"===
this.parent.dataSeries[w].type?(m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0)+0.5:this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum}):s(this.options.label)?Y(c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum,this.valueFormatString,
this.chart._cultureInfo):this.label,this.value=x.dataSeries.dataPointEOs[x.index].cumulativeSum):(m=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:s(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?Y(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataPoint.y);f=
...
null;if("bottom"===this.parent._position||"top"===this.parent._position)"top"===this.parent._position&&h.y-h.fontSize/2<this.chart.bounds.y1&&(h.y=this.chart.bounds.y1+h.fontSize/2),"bottom"===this.parent._position&&this.parent.lineCoordinates.y2-h.fontSize/2+h.measureText().height>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.height+h.fontSize/2+2),b>=this.parent.convertValueToPixel(this.parent.viewportMinimum)&&e<=this.parent.convertValueToPixel(this.parent.viewportMaximum)&&(0<r&&(q.moveTo(b,
f),q.lineTo(e,k),q.stroke(),this._hidden=!1),q.restore(),!s(h.text)&&("number"===typeof h.text.valueOf()||0<h.text.length)&&h.render(!0));if("left"===this.parent._position||"right"===this.parent._position)"left"===this.parent._position&&h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1),"right"===this.parent._position&&h.x+h.measureText().width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.measureText().width),k>=this.parent.convertValueToPixel(this.parent.viewportMaximum)&&f<=this.parent.convertValueToPixel(this.parent.viewportMinimum)&&
(0<r&&(q.moveTo(b,f),q.lineTo(e,k),q.stroke(),this._hidden=!1),q.restore(),!s(h.text)&&("number"===typeof h.text.valueOf()||0<h.text.length)&&h.render(!0))}else{if("bottom"===this.parent._position||"top"===this.parent._position)b=e=l=1===q.lineWidth%2?(a<<0)+0.5:a<<0,f=this.chart.plotArea.y1,k=this.chart.plotArea.y2,this.bounds={x1:b-r/2,y1:f,x2:e+r/2,y2:k};else if("left"===this.parent._position||"right"===this.parent._position)f=k=m=1===q.lineWidth%2?(d<<0)+0.5:d<<0,b=this.chart.plotArea.x1,e=this.chart.plotArea.x2,
this.bounds={x1:b,y1:f-r/2,x2:e,y2:k+r/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){y=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=n)if(this.parent.labels[v])y=!0;else{y=!1;break}if(y){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:d}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=u.index&&
(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?ya(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):
this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?Y(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label);h.y=d+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2+2:h.y+h.measureText().height-h.fontSize/2>this.chart.bounds.y2&&
(h.y=this.chart.bounds.y2-h.measureText().height+h.fontSize/2);"left"===this.parent._position?h.x=this.parent.lineCoordinates.x1-h.measureText().width:"right"===this.parent._position&&(h.x=this.parent.lineCoordinates.x2)}else{if("bottom"===this.parent._position||"top"===this.parent._position)h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?Y(c?c:this.parent.convertPixelToValue(a),
...
v=0;v<this.parent.viewportMaximum;v+=n)if(this.parent.labels[v])y=!0;else{y=!1;break}if(y){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({x:a}),u=null,w=0;w<this.parent.dataSeries.length;w++)(u=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=u.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?c?c:u.dataPoint.label:this.label)}else"dateTime"===
this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?ya(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):
""}):s(this.options.label)?Y(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label);h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width);h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("left"===this.parent._position||"right"===
this.parent._position)h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?Y(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label,h.y=d+h.fontSize/2-h.measureText().height/2+2,h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2+2:h.y+h.measureText().height-h.fontSize/2>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-
...
2:"bottom"===this.parent._position&&this.parent.lineCoordinates.y2-h.fontSize/2+h.measureText().height>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.height+h.fontSize/2+2);0<r&&(q.moveTo(b,f),q.lineTo(e,k),q.stroke(),this._hidden=!1);q.restore();!s(h.text)&&("number"===typeof h.text.valueOf()||0<h.text.length)&&h.render(!0);this.value="bottom"===this.parent._position||"top"===this.parent._position?this.parent.convertPixelToValue(a):this.parent.convertPixelToValue(d)}if("bottom"===this.parent._position||
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(l);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};ma(W,H);W.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
this.enabled||(this.hide(),this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this));if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var b=null,e=null,f=[],k=0;if(this.shared&&this.enabled&&"none"!==this.chart.plotInfo.axisPlacement){if("xySwapped"===this.chart.plotInfo.axisPlacement){var l=[];if(this.chart.axisX)for(var m=0;m<this.chart.axisX.length;m++){for(var k=
this.chart.axisX[m].convertPixelToValue({y:d}),h=null,b=0;b<this.chart.axisX[m].dataSeries.length;b++)(h=this.chart.axisX[m].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&(h.dataSeries=this.chart.axisX[m].dataSeries[b],null!==h.dataPoint.y&&l.push(h));h=null}if(this.chart.axisX2)for(m=0;m<this.chart.axisX2.length;m++){k=this.chart.axisX2[m].convertPixelToValue({y:d});h=null;for(b=0;b<this.chart.axisX2[m].dataSeries.length;b++)(h=this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&
(h.dataSeries=this.chart.axisX2[m].dataSeries[b],null!==h.dataPoint.y&&l.push(h));h=null}}else{l=[];if(this.chart.axisX)for(m=0;m<this.chart.axisX.length;m++)for(k=this.chart.axisX[m].convertPixelToValue({x:a}),h=null,b=0;b<this.chart.axisX[m].dataSeries.length;b++)(h=this.chart.axisX[m].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&(h.dataSeries=this.chart.axisX[m].dataSeries[b],null!==h.dataPoint.y&&l.push(h));if(this.chart.axisX2)for(m=0;m<this.chart.axisX2.length;m++)for(k=this.chart.axisX2[m].convertPixelToValue({x:a}),
h=null,b=0;b<this.chart.axisX2[m].dataSeries.length;b++)(h=this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&(h.dataSeries=this.chart.axisX2[m].dataSeries[b],null!==h.dataPoint.y&&l.push(h))}if(0===l.length)return;l.sort(function(a,b){return a.distance-b.distance});c=l[0];for(b=0;b<l.length;b++)l[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(l[b]);l=null}else{if(h=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=h.dataPointIndex,this.currentSeriesIndex=
...
"normal"}catch(r){}"pie"===f[0].dataSeries.type||"doughnut"===f[0].dataSeries.type||"funnel"===f[0].dataSeries.type||"pyramid"===f[0].dataSeries.type||"bar"===f[0].dataSeries.type||"rangeBar"===f[0].dataSeries.type||"stackedBar"===f[0].dataSeries.type||"stackedBar100"===f[0].dataSeries.type?a=a-10-this.container.clientWidth:(a=f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x)-this.container.clientWidth<<0,a-=10);0>a&&(a+=this.container.clientWidth+20);a+this.container.clientWidth>Math.max(this.chart.container.clientWidth,
...
("line"===b.type||"stepLine"===b.type||"spline"===b.type||"scatter"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"stackedArea"===b.type||"stackedArea100"===b.type||"rangeArea"===b.type||"rangeSplineArea"===b.type?(f=b.getMarkerProperties(k,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=Math.max(1.5*f.size<<0,10),f.borderColor=f.borderColor||"#FFFFFF",f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),V.drawMarkers([f]),"undefined"!==typeof e.y2&&(f=b.getMarkerProperties(k,
e.x1,e.y2,this.chart.overlaidCanvasCtx),f.size=Math.max(1.5*f.size<<0,10),f.borderColor=f.borderColor||"#FFFFFF",f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),V.drawMarkers([f]))):"bubble"===b.type?(f=b.getMarkerProperties(k,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=e.size,f.color="white",f.borderColor="white",d.globalAlpha=0.3,V.drawMarkers([f]),d.globalAlpha=1):"column"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"bar"===b.type||"rangeBar"===b.type||"stackedBar"===
b.type||"stackedBar100"===b.type||"rangeColumn"===b.type||"waterfall"===b.type?Z(d,e.x1,e.y1,e.x2,e.y2,"white",0,null,!1,!1,!1,!1,0.3):"pie"===b.type||"doughnut"===b.type?fa(d,e.center,e.radius,"white",b.type,e.startAngle,e.endAngle,0.3,e.percentInnerRadius):"funnel"===b.type||"pyramid"===b.type?pa(d,e.funnelSection,0.3,"white"):"candlestick"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,Math.min(e.y2,e.y3)),
d.lineTo(e.x3-b,Math.min(e.y1,e.y4)),d.stroke(),d.beginPath(),d.moveTo(e.x3-b,Math.max(e.y1,e.y4)),d.lineTo(e.x3-b,Math.max(e.y2,e.y3)),d.stroke(),Z(d,e.x1,Math.min(e.y1,e.y4),e.x2,Math.max(e.y1,e.y4),"transparent",2*e.borderThickness,e.color,!1,!1,!1,!1),d.globalAlpha=1):"ohlc"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,e.y2),d.lineTo(e.x3-b,e.y3),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y1),d.lineTo(e.x1,
e.y1),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4),d.lineTo(e.x2,e.y4),d.stroke(),d.globalAlpha=1):"boxAndWhisker"===b.type?(d.save(),d.globalAlpha=1,d.strokeStyle=e.stemColor,d.lineWidth=2*e.stemThickness,0<e.stemThickness&&(d.beginPath(),d.moveTo(e.x3,e.y2+e.borderThickness/2),d.lineTo(e.x3,e.y1+e.whiskerThickness/2),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4-e.whiskerThickness/2),d.lineTo(e.x3,e.y3-e.borderThickness/2),d.stroke()),d.beginPath(),Z(d,e.x1-e.borderThickness/2,Math.max(e.y2+e.borderThickness/
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.0.5 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
